 ...
 */
package com.ibd.cohesive.app.business.batch.fee;
 ...
 */
@Stateless
public class FeeProcessing implements IFeeProcessing {
    AppDependencyInjection inject;
    CohesiveSession session;
    DBSession dbSession;
    
     public FeeProcessing() throws NamingException {
       ...
       try{
        ...
        dbts.updateColumn("INSTITUTE"+i_db_properties.getProperty("FOLDER_DELIMITER")+instituteID+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate, "BATCH", "FEE_EOD_STATUS", l_pkeyy, column_to_Update,session); 
     ...
     private void sequentialProcessing(String instituteID,String feeID,String l_businessDate)throws DBProcessingException,DBValidationException,BSProcessingException,BSValidationException{
      ...
      try{
           ...
           batchUtil=inject.getBatchUtil(session);
            ...
            Map<String,DBRecord>studentEodMap=readBuffer.readTable("INSTITUTE"+i_db_properties.getProperty("FOLDER_DELIMITER")+instituteID+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+"Fee"+i_db_properties.getProperty("FOLDER_DELIMITER")+feeID, "BATCH", "STUDENT_FEE_EOD_STATUS", session, dbSession);
...
//                             batchUtil.getStudentFeeHistoryMaxSequence(l_businessDate, instituteID, feeID, l_studentID, inject, session, dbSession);
                            ...
                            dbts.updateColumn("INSTITUTE"+i_db_properties.getProperty("FOLDER_DELIMITER")+instituteID+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+"Fee"+i_db_properties.getProperty("FOLDER_DELIMITER")+feeID, "BATCH", "STUDENT_FEE_EOD_STATUS", l_pkey, column_to_Update,session); 
           ...
           dbg("l_studentOfTheGroup"+l_studentOfTheGroup.size());        
                ...
                for(int j=0;j<l_studentOfTheGroup.size();j++){
                    ...
                    try{ 
                         ...
                         dbts.createRecord(session,"INSTITUTE"+i_db_properties.getProperty("FOLDER_DELIMITER")+instituteID+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+"Fee"+i_db_properties.getProperty("FOLDER_DELIMITER")+feeID, "BATCH", 120,instituteID,feeID,l_studentID,l_businessDate,"W"," "," "," ");   
                          tc.commit(session, dbSession);
                     }catch(DBValidationException ex){
                        tc.rollBack(session, dbSession);
...
//        column_to_Update.put("9", startTime);
//        String[] l_pkeyy={instituteID,feeID,l_businessDate};
//        dbts.updateColumn("BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate, "BATCH", "FEE_EOD_STATUS", l_pkeyy, column_to_Update,session); 
//        tc.commit(session, dbSession);
//                
//              studentIdentification(instituteID,l_businessDate,feeID,groupID) ;   
//              
...
//           batchUtil=inject.getBatchUtil(session);
//      
//            Map<String,DBRecord>studentEodMap=readBuffer.readTable("BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate, "BATCH", "STUDENT_FEE_EOD_STATUS", session, dbSession);
...
//                            column_to_Update.put("5", "W");
//                            String[]l_pkey={instituteID,feeID,l_studentID,l_businessDate};
//                            dbts.updateColumn("BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+l_businessDate, "BATCH", "STUDENT_FEE_EOD_STATUS", l_pkey, column_to_Update,session); 
//                            batchUtil.moveStudentFeeRecordToHistory(instituteID,feeID,l_studentID,l_businessDate,studentFeeRecord, session, dbSession, inject);
//                         }
//                         tc.commit(session, dbSession);
//                         
