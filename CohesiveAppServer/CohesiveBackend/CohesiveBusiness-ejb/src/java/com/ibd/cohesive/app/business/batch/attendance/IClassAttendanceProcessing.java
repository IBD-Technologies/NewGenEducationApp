 ...
 * @author DELL
 */
public interface IClassAttendanceProcessing {
    public void processing(String instituteID,String standard,String section,String l_businessDate,CohesiveSession session) throws DBProcessingException,DBValidationException,BSProcessingException,BSValidationException;
