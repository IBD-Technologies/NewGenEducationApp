 ...
 */
public interface IResourceTokenBridge {
     public SecretKey getKey() throws NamingException;
    // public JWSSigner getSigner() throws NamingException,JOSEException;
     public byte[] getSharedSecret()throws NamingException;

     public void setKey(SecretKey key) throws NamingException;
     //public void setSigner(JWSSigner signer)throws NamingException,JOSEException;
