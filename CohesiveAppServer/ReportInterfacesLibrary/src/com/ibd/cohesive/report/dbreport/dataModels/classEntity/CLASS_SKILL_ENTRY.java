 ...
 * @author ibdtech
 */
public class CLASS_SKILL_ENTRY {
    String STANDARD;
    String SECTION;
    String EXAM;
    String SKILL_ID;
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
     ...
     public ArrayList<CLASS_SKILL_ENTRY>convertStringToArrayList(String result){
        
          ArrayList<CLASS_SKILL_ENTRY> CLASS_SKILL_ENTRYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              CLASS_SKILL_ENTRY appStatus=new CLASS_SKILL_ENTRY();
              ...
              appStatus.setSKILL_ID(record.split("~")[10]);
              appStatus.setSTANDARD(record.split("~")[11]);
              appStatus.setVERSION_NUMBER(record.split("~")[12]);
              
              
              
              
           CLASS_SKILL_ENTRYList.add(appStatus);
          }
          
        return CLASS_SKILL_ENTRYList;
