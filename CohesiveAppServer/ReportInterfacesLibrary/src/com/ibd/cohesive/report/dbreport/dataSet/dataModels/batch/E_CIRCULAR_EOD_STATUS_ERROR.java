 ...
 * @author ibdtech
 */
public class E_CIRCULAR_EOD_STATUS_ERROR {
  String INSTITUTE_ID;
    ...
    public void setERROR(String ERROR) {
      ...
      public ArrayList<E_CIRCULAR_EOD_STATUS_ERROR>convertStringToArrayList(String result){
        
          ArrayList<E_CIRCULAR_EOD_STATUS_ERROR> E_CIRCULAR_EOD_STATUS_ERRORList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              E_CIRCULAR_EOD_STATUS_ERROR appStatus=new E_CIRCULAR_EOD_STATUS_ERROR();
              ...
              E_CIRCULAR_EOD_STATUS_ERRORList.add(appStatus);
          }
          
          
          return E_CIRCULAR_EOD_STATUS_ERRORList;
      }
}
