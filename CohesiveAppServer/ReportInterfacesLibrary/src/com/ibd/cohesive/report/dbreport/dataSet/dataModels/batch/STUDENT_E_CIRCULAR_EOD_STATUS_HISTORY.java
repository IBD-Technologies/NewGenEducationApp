 ...
 * @author ibdtech
 */
public class STUDENT_E_CIRCULAR_EOD_STATUS_HISTORY {
    String INSTITUTE_ID;
    ...
    public ArrayList<STUDENT_E_CIRCULAR_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<STUDENT_E_CIRCULAR_EOD_STATUS_HISTORY> STUDENT_E_CIRCULAR_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              STUDENT_E_CIRCULAR_EOD_STATUS_HISTORY appStatus=new STUDENT_E_CIRCULAR_EOD_STATUS_HISTORY();
              ...
              STUDENT_E_CIRCULAR_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return STUDENT_E_CIRCULAR_EOD_STATUS_HISTORYList;
