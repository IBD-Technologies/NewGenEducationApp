 ...
 app.config(function($routeProvider){
	 ...
	 .when("/PostViewOperation",{template:'<div id="PostViewOperation">\n'+
             ...
             //          '<li class="page-item"><a id="Edit" ng-click ="fnEdit($event)" class="page-link page_style" href="#!PostTranOperation">Edit<span class="badge badge-link cohesive_badge"><i class="fas fa-pen-square"></i></span></a></li>\n'+
                        '<li class="page-item"><a id="Authorize" ng-click ="fnAuthorise($event)" class="page-link page_style" href="#!defaultOperation">Enroll<span class="badge badge-link cohesive_badge"><i class="fas fa-check-circle"></i></span></a></li>\n'+
...
{
   OperationScopes.store('operationCtl', $scope); 
	 var fn = window["fn"+MenuName+"Enroll"];
    ...
    //Select Box change ends
               switch(parentOperation)
		          ...
		          case 'Auth':
		            ...
		            $anchorScroll();
                            //$scope.$apply();     
            	            fn_Show_Information('FE-VAL-034','S');
			             break;
		          case 'Reject':
                              previousAuditScope={};
                            $location.url('/defaultOperation');
   ...
   switch(operation)
   {
      ...
      case 'Edit':
		 ...
		 { 		 
		    if($scope1.audit.MakerID!=userID)
	 		...
	 		else 
			   {
			     //$scope1.audit.Version=audit.Version;
		         //$scope1.audit.MakerID=audit.MakerID;
		         previousAuditScope= Object.assign({}, $scope1.audit);   
        ...
        /* if (audit.RecordStat=='D')
		 ...
		 if ($scope1.audit.AuthStat!='Authorised')
		 {
...
{
	fn_show_confirmation('FE-VAL-033',$scope,'Auth');
	//if (!confirmation)
	//return false;
return true;	
}
