 ...
 app.config(function($routeProvider){
	 ...
	 .when("/PostViewOperation",{template:'<div id="PostViewOperation">\n'+
             ...
             //          '<li class="page-item"><a id="Edit" ng-click ="fnEdit($event)" class="page-link page_style" href="#!PostTranOperation">Edit<span class="badge badge-link cohesive_badge"><i class="fas fa-pen-square"></i></span></a></li>\n'+
                        '<li class="page-item"><a id="Authorize" ng-click ="fnAuthorise($event)" class="page-link page_style" href="#!defaultOperation">Sign<span class="badge badge-link cohesive_badge"><i class="fas fa-check-circle"></i></span></a></li>\n'+
    ...
    //Select Box change ends
               switch(parentOperation)
		          ...
		          case 'Auth':
		            ...
		            $anchorScroll();
                            //$scope.$apply();     
            	            fn_Show_Information('FE-VAL-037','S');
			             break;
		          case 'Reject':
                              previousAuditScope={};
                            $location.url('/defaultOperation');
...
{
	fn_show_confirmation('FE-VAL-036',$scope,'Auth');
	//if (!confirmation)
	//return false;
return true;	
}
