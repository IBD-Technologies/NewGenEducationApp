...
$(document).ready(function () {
	MenuName = "ComparisonAccrossAllExam";
	//-----------------------  screen Specific Default Recors      --------------------------------------------------	
});
// Cohesive View Framework Starts
function fnComparisonAccrossAllExamView() {
	var emptyComparisonAccrossAllExam = {
		Master: {
		    teacherName: null,
			teacherID: null
			},
	...
	var response = fncallBackend('ComparisonAccrossAllExam', 'View', dataModel, [$scope.teacherID,$scope.teacherName], $scope);
...
function fnComparisonAccrossAllExamMandatoryCheck(operation) {
	var $scope = angular.element(document.getElementById('SubScreenCtrl')).scope();
...
function fnComparisonAccrossAllExamDefaultandValidate(operation) {
	var $scope = angular.element(document.getElementById('SubScreenCtrl')).scope();
	switch (operation) {
		case 'View':
...
function fnComparisonAccrossAllExamBack() {
	var $scope = angular.element(document.getElementById('SubScreenCtrl')).scope();
		// Screen Specific Scope Starts
	    $scope.teacherID = null;
		$scope.teacherName = null;
