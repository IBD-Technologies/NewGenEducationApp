<%-- 
   Document   : StudentFeeManagementSummary
   Created on : Jul 30, 2019, 11:15:14 AM
   ...
   --%>
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <script src="/js/StudentFeeManagementSummary.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center"> Student Fee Management Summary </h6>
                ...
                <div id="subscreenContent" class="subscreenContent">
                    ...
                    <div id="mastersection" ng-show="!searchShow&&mastershow">
                          <!--  <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active " data-toggle="tab" href="#subStudent" role="tab" aria-controls="subStudent" aria-selected="true">Student</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#subFee" role="tab" aria-controls="subFee" aria-selected="false">Fee</a>
                            </li>
                        </ul>-->
                        <!--<div class="tab-content" id="myTab">-->
                           ...
                           <!-- </div>-->
                            <!--<div class="tab-pane fade" id="subFee" role="tabpanel">-->
                                <!--<div class="form-group row">
                                    ...
                                    <div class=" input-group col-9">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" id="paidDateShow" ng-disabled="paidDateReadonly" class="btn btn-primary"><i class="far fa-calendar-alt"></i></button>
                                        </div>
                                    </div>
                                </div>-->
                                <div class="form-group row">
                    ...
                    <div id="detailSection" ng-show="!searchShow&&detailshow">
                        <div class="text-center contentDetailTab">Student Fee Management</div>
                        <nav class="navbar navbar-light bg-light contentDetailTabNav">
                            <ul class="pagination pagination-sm   mb-0">
                                <li class="page-item"><a class="page-link page_style svwRecCount"><span class="svwRecCount">{{fnMvwGetCurrentPage('SFMSummary')}}</span></a></li>
                                ...
                                <li class="page-item">
                                    <a class="page-link page_style svwRecCount">
                                        <span class="svwRecCount">{{fnMvwGetTotalPage('SFMSummary')}}</span></a>
                                </li>
                            </ul>
                            <div>
                            </div>
                            <ul class="pagination pagination-sm justify-content-end mb-0">
                                <li class="page-item"><a id="backwardButton" ng-click="fnMvwBackward('SFMSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-left"></i></span></a></li>
                                <li class="page-item"><a id="forwardButton" ng-click="fnMvwForward('SFMSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-right"></i></span></a></li>
                                <li class="page-item">
                                    <a id="addButton" ng-click="fnMvwAddRow('SFMSummary',$event)" class="page-link page_style"> <span class="badge badge-light cohesive_badge"><i class="fas fa-plus"></i></span></a>
                                </li>
                                <li class="page-item"><a id="deleteButton" ng-click="fnMvwDeleteRow('SFMSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-minus"></i></span></a></li>
                            </ul>
                        </nav>
                        <div class="table-responsive" id="SFMSummary">
                            <table class="table table-striped table-sm table-bordered ">
                                <thead align="center">
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col">Fee ID</th>
                                        <th scope="col">Due Date(DD/MM/YYYY)</th>
                                        <th scope="col">Fee Amount</th>
                                        <th scope="col">Paid Amount</th>
                                        <!--<th scope="col">Paid Date (DD/MM/YYYY)</th>-->
                                    </tr>
                                </thead>
                                <tbody align="center">
                                    <tr ng-repeat="X in StudentFeeManagementSummaryShowObject">
                                        <td>
