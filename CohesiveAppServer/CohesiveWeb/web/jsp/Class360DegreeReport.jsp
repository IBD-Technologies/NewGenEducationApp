<%-- 
    Document   : Class360Report
    Created on : Aug 4, 2019, 11:05:09 AM
...
--%>
    ...
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <script type="text/javascript" src="/js/Class360DegreeReport.js"></script>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center">Class 360 Degree Report</h6>
