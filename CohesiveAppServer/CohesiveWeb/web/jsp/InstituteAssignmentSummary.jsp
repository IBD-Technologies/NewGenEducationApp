<%-- 
   Document   : InstituteAssignmentSummary
   Created on : Jul 30, 2019, 12:17:15 PM
...
<html>
   <head>
      ...
      <script type ="text/javascript" src="/js/InstituteAssignmentSummary.js"></script>
   </head>
     ...
     <%
      ...
      <header id="subscreenHeader" class="subscreenHeader mb-3">
         <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
            <h6 align="center"> Assignment Summary </h6>
      ...
      <div id="subscreenContent" class="subscreenContent">
         ...
         <div id="mastersection" ng-show="!searchShow&&mastershow">
            ...
            <div class= "form-group row ">
               ...
               <div class="col-9">
                  <div class=" input-group ">
                     <select class="custom-select" id="subject" ng-disabled="subjectNamereadOnly" ng-model="subjectName">
            ...
            <div class ="form-group row">
               <label for="assignmentDueDate" class="col-3 col-form-label">Due Date</label>
               <div class="col-9">
                  <div class="input-group">
                     <input id="assignmentDueDate" type="text" ng-readonly="dueDatereadOnly" ng-model="dueDate" class="form-control">
                     <div class="input-group-append">
                        <button type="button" ng-disabled="dueDatereadOnly" id="assignmentDueDateShow" class="btn btn-primary"><i class="far fa-calendar-alt"></i></button>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div id="detailSection" ng-show="!searchShow&&detailshow">
            <div class="text-center contentDetailTab">Assignment </div>
            <nav class="navbar navbar-light bg-light contentDetailTabNav">
               <ul class="pagination pagination-sm   mb-0">
                  <li class="page-item"><a  class="page-link page_style svwRecCount"><span class="svwRecCount">{{fnMvwGetCurrentPage('instituteAssignmentSummary')}}</span></a></li>
                  ...
                  <li class="page-item"><a class="page-link page_style svwRecCount">
                     <span class="svwRecCount">{{fnMvwGetTotalPage('instituteAssignmentSummary')}}</span></a>
                  </li>
               </ul>
               <div>
               </div>
               <ul class="pagination pagination-sm justify-content-end mb-0">
                  <li class="page-item"><a id="backwardButton" ng-click="fnMvwBackward('instituteAssignmentSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-left"></i></span></a></li>
                  <li class="page-item"><a id="forwardButton" ng-click="fnMvwForward('instituteAssignmentSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-right"></i></span></a></li>
                  <li class="page-item"><a id="addButton" ng-click="fnMvwAddRow('instituteAssignmentSummary',$event)" class="page-link page_style"> <span class="badge badge-light cohesive_badge"><i class="fas fa-plus"></i></span></a></li>
                  <li class="page-item"><a id="deleteButton" ng-click="fnMvwDeleteRow('instituteAssignmentSummary',$event)"   
                     class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-minus"></i></span></a></li>
               </ul>
            </nav>
            <div class="table-responsive" id="instituteAssignmentSummary">
               <table class="table table-striped table-sm table-bordered ">
                  ...
                  <tbody  align="center">
                     <tr ng-repeat="X in instituteAssignmentSummaryShowObject">
                        <td>
