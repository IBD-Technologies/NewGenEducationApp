<%-- 
    ...
    Created on : Aug 4, 2019, 9:52:10 PM
...
--%>
     ...
     <%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix = "c" %>
        ...
        <head>
            ...
            <!--Js Framework Ends-->
            <script src="/js/StudentExamSchedule.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center"> Student Exam Schedule</h6>
                        ...
                        <div ng-show="SubjectschedulesShowObject" id="examSchedule">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group-prepend col-9">
                                    ...
                                    <select class="custom-select" id="endTimeMin" ng-disabled="endTimereadOnly" ng-model="SubjectschedulesRecord.endTime.min">
                                        <option ng-repeat="x in Minutes" value="{{x}}">{{x}}</option>
                                    </select>
                                </div>
                            </div>
