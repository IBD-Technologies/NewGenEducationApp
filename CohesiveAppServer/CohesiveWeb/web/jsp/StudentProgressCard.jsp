        ...
        <head>
            ...
            <%--<c:forEach items="${cookie}" var="currentCookie">  
                ...
                <c:if test="${currentCookie.value.value=='P'}">
                    <script type="text/javascript" src="/js/Utils/StudentConfirmation.js"></script>
                </c:if>
            ...
            <!-- Js Framework Ends---->
            <script type="text/javascript" src="/js/StudentProgressCard.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center">Student Progress Card</h6>
                            ...
                            <div class="tab-pane fade show active" id="markEntry" role="tabpanel" aria-labelledby="mark-Entry">
                                ...
                                <nav class="navbar navbar-light bg-light contentDetailTabNav">
                                    <ul class="pagination pagination-sm   mb-0">
                                        <li class="page-item"><a class="page-link page_style svwRecCount"><span class="svwRecCount">{{fnMvwGetCurrentPage('studentProgressCard')}}</span></a></li>
                                        ...
                                        <li class="page-item">
                                            <a class="page-link page_style svwRecCount">
                                                <span class="svwRecCount">{{fnMvwGetTotalPage('studentProgressCard')}}</span></a>
                                        </li>
                                    </ul>
                                    <div>
                                    </div>
                                    <ul class="pagination pagination-sm justify-content-end mb-0">
                                        <li class="page-item"><a id="backwardButton" ng-click="fnMvwBackward('studentProgressCard',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-left"></i></span></a></li>
                                        <li class="page-item"><a id="forwardButton" ng-click="fnMvwForward('studentProgressCard',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-right"></i></span></a></li>
                                        <li class="page-item">
                                            <a id="addButton" ng-click="fnMvwAddRow('studentProgressCard',$event)" class="page-link page_style"> <span class="badge badge-light cohesive_badge"><i class="fas fa-plus"></i></span></a>
                                        </li>
                                        <li class="page-item"><a id="deleteButton" ng-click="fnMvwDeleteRow('studentProgressCard',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-minus"></i></span></a></li>
                                    </ul>
                                </nav>
                                <div class="table-responsive" id="studentProgressCard">
                                    <table class="table  cohesive_table table-sm  table-bordered ">
                                        ...
                                        <tbody id="TTbody" align="center">
                                            <tr ng-repeat="X in StudentProgressCardShowObject">
                                                <td>
                                                    <input type="checkbox" ng-model="X.checkBox">
                                                </td>
                                                <th scope="col">{{X.subjectName}}</th>
                                                <td ng-model="x.mark">
                                                    <input type="text" class="form-control-plaintext" ng-model="X.mark" ng-readonly="markReadOnly">
                                                </td>
                                                <td ng-model="x.grade">
                                                    <input type="text" class="form-control-plaintext" ng-model="X.grade" ng-readonly="markReadOnly">
                                                </td>
                                                <td>
