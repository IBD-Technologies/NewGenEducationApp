...
<html>
   <head>
      ...
      <script  type ="text/javascript" src="/js/TableReport.js"></script>	
   </head>
     ...
     <%
      ...
      <header id="subscreenHeader" class="subscreenHeader mb-3">
         <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
            <h6 align="center">Table Report</h6>
      ...
      <div id="subscreenContent" class="subscreenContent">
         ...
         <div id="mastersection" ng-show="!searchShow&&mastershow">
            <div class ="form-group row">
               <label for="tableName" class="col-3 col-form-label">Table Name</label>
               <div class="col-9">
                  <div class="input-group">
                     <input id="tableName" type="text" ng-readonly="tableNamereadOnly"  ng-model="tableName" class="form-control">
                   <!--  <div class="input-group-append">
                        <button type="button" class="btn btn-primary" ng-click="fnStSearch()"><i class="fas fa-search"></i></button>
                     </div> -->
                  </div>
               </div>
            </div>
            <div class ="form-group row">
               <label for="queryParam" class="col-3 col-form-label">Query Parameter</label>
               <div class="col-9">
                  <div class="input-group">
                     <input id="queryParam" type="text" ng-readonly="queryParamreadOnly" ng-model="queryParam" class="form-control">
                  </div>
               </div>
            </div>
         </div>
         <div id="detailSection" ng-show="!searchShow&&detailshow" style="height:100%">
          <div class="embed-responsive cohesive-embed-responsive embed-responsive-1by1">
                  <iframe src="" id ="reportFrame" class="embed-responsive-item" >
                      
                  </iframe>
         </div> 
         <!-- <p><a href="" download> Click to Download </a></p> -->
      </div>
