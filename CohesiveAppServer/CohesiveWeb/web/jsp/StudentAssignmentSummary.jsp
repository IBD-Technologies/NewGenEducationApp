<%-- 
   Document   : StudentAssignmentSummary
   Created on : Jul 30, 2019, 7:17:52 PM
   ...
   --%>
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <script src="/js/StudentAssignmentSummary.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center">Student Assignment Summary</h6>
                ...
                <div id="subscreenContent" class="subscreenContent">
                    ...
                    <div id="mastersection" ng-show="!searchShow&&mastershow">
                          ...
                          <!--<ul class="nav nav-tabs mb-4" id="subTab" role="tablist">
                                    ...
                                    <!--<li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#assignmentTab" role="tab" aria-selected="false">Assignment</a>
                                    </li>-->
                       <!-- </ul>-->
                       <!--<div class="tab-content" id="subTab">-->
                            <!--<div class="tab-pane fade show active " id="studentTab" role="tabpanel">-->
                               ...
                               <div class="col-9">
                                  <div class="input-group">
                                     <input id="studName" type="text" ng-readonly="studentNamereadOnly"  ng-model="studentName" class="form-control" readonly>
                                     <div class="input-group-append">
                        ...
                        <div class="col-9">
                            ...
                            <!--<div class="tab-pane fade" id="assignmentTab" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" input-group col-9">
                                        <select id="Status" class="custom-select" ng-disabled="statusReadonly" ng-model="status">
                                            <option ng-repeat="x in Status" value="{{x}}">{{x}}</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="SubjectName" class="col-3 col-form-label">Subject</label>
                                    <div class="col-9">
                                        <div class="input-group">
                                            <select class="custom-select" id="SubjectName" ng-disabled="subjectNamereadOnly" ng-model="subjectName">
                                                <option ng-repeat="x in subjects" value="{{x}}">{{x}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="detailSection" ng-show="!searchShow&&detailshow">
                        <div class="text-center contentDetailTab">Student Assignment </div>
                        <nav class="navbar navbar-light bg-light contentDetailTabNav">
                            <ul class="pagination pagination-sm   mb-0">
                                <li class="page-item"><a class="page-link page_style svwRecCount"><span class="svwRecCount">{{fnMvwGetCurrentPage('studentAssignmentSummary')}}</span></a></li>
                                ...
                                <li class="page-item">
                                    <a class="page-link page_style svwRecCount">
                                        <span class="svwRecCount">{{fnMvwGetTotalPage('studentAssignmentSummary')}}</span></a>
                                </li>
                            </ul>
                            <div>
                            </div>
                            <ul class="pagination pagination-sm justify-content-end mb-0">
                                <li class="page-item"><a id="backwardButton" ng-click="fnMvwBackward('studentAssignmentSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-left"></i></span></a></li>
                                <li class="page-item"><a id="forwardButton" ng-click="fnMvwForward('studentAssignmentSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-right"></i></span></a></li>
                                <li class="page-item">
                                    <a id="addButton" ng-click="fnMvwAddRow('studentAssignmentSummary',$event)" class="page-link page_style"> <span class="badge badge-light cohesive_badge"><i class="fas fa-plus"></i></span></a>
                                </li>
                                <li class="page-item"><a id="deleteButton" ng-click="fnMvwDeleteRow('studentAssignmentSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-minus"></i></span></a></li>
                            </ul>
                        </nav>
                        <div class="table-responsive" id="studentAssignmentSummary">
                            <table class="table table-striped table-sm table-bordered ">
                                ...
                                <tbody align="center">
                                    <tr ng-repeat="X in StudentAssignmentSummaryShowObject">
                                        <td>
