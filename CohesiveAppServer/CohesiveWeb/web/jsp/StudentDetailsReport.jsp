...
<html>
   <head>
      ...
      <script  type ="text/javascript" src="/js/StudentDetailsReport.js"></script>	
   </head>
     ...
     <%
      ...
      <header id="subscreenHeader" class="subscreenHeader mb-3">
         <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
            <h6 align="center">Students Register</h6>
      ...
      <div id="subscreenContent" class="subscreenContent">
         ...
         <div id="mastersection" ng-show="!searchShow&&mastershow">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                                    <label for="studentStatus" class="col-3 col-form-label">Status</label>
                                        <div class=" input-group col-9">
                                            <select class="custom-select" id="studentStatus" ng-disabled="studentStatusreadOnly" ng-model="studentStatus">
                                                <option ng-repeat="x in StudentStatus" value="{{x.value}}">{{x.name}}</option>
                                            </select>
                                        </div>
                                </div>
