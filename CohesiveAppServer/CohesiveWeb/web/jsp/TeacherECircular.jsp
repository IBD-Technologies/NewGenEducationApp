        ...
        <head>
            ...
            <%--<c:forEach items="${cookie}" var="currentCookie">  
                ...
                <c:if test="${currentCookie.value.value=='P'}">
                    <script type="text/javascript" src="/js/Utils/TeacherView.js"></script>
                </c:if>
            ...
            <!--Js Framework Ends-->
            <script type="text/javascript" src="/js/TeacherECircular.js"></script>
        </head>
                    ...
                    <div id="mastersection" ng-show="!searchShow&&mastershow">
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" input-group-append col-9">
                                <input id="studID" type="text" ng-readonly="teacherIDreadOnly" ng-model="teacherID" class="form-control">
                            </div>
                        </div>
