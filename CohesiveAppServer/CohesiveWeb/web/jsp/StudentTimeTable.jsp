                            ...
                            <div class="tab-pane fade show active" id="monday" role="tabpanel" aria-labelledby="mondayTab">
                                ...
                                <div ng-show="MondayShowObject" id="mondayTable">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                <input id="staffName" type="text" ng-readonly="teacherNameReadonly" ng-model="MondayRecord.teacherName" class="form-control">
                                                <div class="input-group-append">
                                ...
                                <div ng-show="TuesdayShowObject" id="tuesdayTable">
                                    ...
                                    <div class="form-group row ">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                <input id="staffName" type="text" ng-readonly="teacherNameReadonly" ng-model="TuesdayRecord.teacherName" class="form-control">
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-primary" ng-disabled="teacherNameReadonly" ng-click="fnTeacherSearch()"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="wednesday" role="tabpanel" aria-labelledby="wednesdayTab">
                                ...
                                <div ng-show="WednesdayShowObject" id="wednesdayTable">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                <input id="staffName" type="text" ng-readonly="teacherNameReadonly" ng-model="WednesdayRecord.teacherName" class="form-control">
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-primary" ng-disabled="teacherNameReadonly" ng-click="fnTeacherSearch()"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade " id="thursday" role="tabpanel" aria-labelledby="thursdayTab">
                                ...
                                <div ng-show="ThursdayShowObject" id="thursdayTable">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                <input id="staffName" type="text" ng-readonly="teacherNameReadonly" ng-model="ThursdayRecord.teacherName" class="form-control">
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-primary" ng-disabled="teacherNameReadonly" ng-click="fnTeacherSearch()"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="friday" role="tabpanel" aria-labelledby="fridayTab">
                                ...
                                <div ng-show="FridayShowObject" id="fridayTable">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                <input id="teacherName" type="text" ng-readonly="teacherNameReadonly" ng-model="FridayRecord.teacherName" class="form-control">
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-primary" ng-disabled="teacherNameReadonly" ng-click="fnTeacherSearch()"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
