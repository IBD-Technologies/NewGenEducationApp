<%-- 
    Document   : InstituteFeePayment
    Created on : Jul 17, 2019, 1:55:31 PM
...
--%>
    ...
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <script src="/js/InstitutePayment.js"></script>
         ...
         %>
                ...
                <div id="subscreenContent" class="subscreenContent">
                    ...
                    <div id="mastersection" ng-show="!searchShow&&mastershow"> 
                        ...
                        <!--<ul class="nav nav-tabs mb-4 " id="masterSubTab" role="tablist">
						    <li class="nav-item cohesiveTabPadding">
                                <a class="nav-link active" id="studentTab" data-toggle="tab" href="#student" role="tab" aria-selected="false">Student</a>
                            </li>
                            
                            <li class="nav-item cohesiveTabPadding">
                                <a class="nav-link" id="paymentTab" data-toggle="tab" href="#payment" role="tab" aria-selected="false">Payment</a>
                            </li>
                        </ul>-->
                        
                        <!--<div class="tab-content" id="masterSubTab">-->
               ...
               <div class="col-9">
                  <div class="input-group">
                     <input id="iID" type="text" ng-readonly="instituteIDreadOnly" ng-model="instituteID" class="form-control">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-primary" ng-disabled="paymentSearchreadOnly" ng-click="fnPaymentSearch()"><i class="fas fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="tab-pane fade show active" id="student" role="tabpanel" aria-labelledby="studentTab">
                        <div class="form-group row">
                    ...
                    <div id="detailSection" ng-show="!searchShow&&detailshow">
                          ...
                          <!--<ul class="nav nav-tabs mb-4 " id="detailSubTab" role="tablist">
                            ...
                            <li class="nav-item cohesiveTabPadding">
                                <a class="nav-link " id="feeTab" data-toggle="tab" href="#fee" role="tab" aria-selected="true">Fee</a>
                            </li>
                            <li class="nav-item cohesiveTabPadding">
                                <a class="nav-link" id="paymentTab" data-toggle="tab" href="#payment" role="tab" aria-selected="false">Payment</a>
                            </li>
                       ...
                       <div class="tab-pane fade " id="fee" role="tabpanel" aria-labelledby="feeTab">
                        <div class="form-group row">
                            <label for="feeID" class="col-3 col-form-label">Fee ID</label>
                            <div class="col-9">
                                <div class="input-group">
                                    <input id="feeID" type="text" ng-readonly="feeIDreadOnly" ng-model="feeID" class="form-control">
                                    <div class="input-group-append">
                                        <button type="button" ng-disabled="feeIDreadOnly" ng-click="fnFeeSearch()" class="btn btn-primary"><i class="fas fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="feeDescription" class="col-3 col-form-label">Description</label>
                            <div class="col-9">
                                <div class="input-group">
                                    <input id="feeDescription" type="text" ng-readonly="feeDescriptionreadOnly" ng-model="feeDescription" class="form-control">
                                   <!-- <select class="custom-select" id="feeDescription" ng-disabled="feeDescriptionreadOnly" ng-model="feeDescription">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <input id="feeAmount" ng-readonly="amountreadOnly" ng-model="amount" class="form-control currency">
                                </div>
                            </div>
                        </div>
                       </div>
                      <div class="tab-pane fade" id="payment" role="tabpanel" aria-labelledby="paymentTab">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                <input id="feeOutstanding" ng-readonly="outStandingreadOnly" ng-model="outStanding" class="form-control currency">
                            </div>
                        </div>
                        </div>
                        <div class="form-group row">
                  ...
                  <div class="table-responsive" id="markEntry">
                   <table class="table  cohesive_table table-sm  table-bordered ">
                    ...
                    <div id="searchBody" ng-controller="paymentIDsearch">
                    </div>
                    <div id="searchBody" ng-controller="feeIDsearch">
                    </div>
                     <div id="search" ng-controller="InstituteNamesearch">		
                     </div>
                </div>
