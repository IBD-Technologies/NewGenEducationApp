<%-- 
    Document   : InstituteFeeManagement
    Created on : Jul 17, 2019, 6:53:01 PM
...
--%>
    ...
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <!--Js Framework Ends-->
            <script type="text/javascript" src="/js/InstituteFeeManagement.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center"> Fee Management</h6>
               ...
               <div class="col-9">
                  <div class="input-group">
                     <input id="iID" type="text" ng-readonly="instituteIDreadOnly" ng-model="instituteID" class="form-control">
                        ...
                        <div class ="form-group row">
               <label for="feeDescription" class="col-3 col-form-label">Fee Description</label>
               <div class="col-9">
                  <div class="input-group">
