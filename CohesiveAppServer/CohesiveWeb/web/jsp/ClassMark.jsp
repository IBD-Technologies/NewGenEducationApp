...
<html>
   <head>
      ...
      <!--Js Framework Ends-->
      <script src="/js/ClassMark.js"></script>
   </head>
   <body id ="SubScreenCtrl" class="cohesive_body" ng-app="SubScreen" ng-Init="searchShow=false" ng-controller="SubScreenCtrl">
       ...
       <header id="subscreenHeader" class="subscreenHeader mb-3">
         <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
             <h6 align="center">Exam Assessment</h6> 
      ...
      <div id="subscreenContent" class="subscreenContent">
         ...
         <div id="detailSection" ng-show="!searchShow&&detailshow">
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
               <li class="nav-item">
                  <a class="nav-link active"  data-toggle="tab" href="#markEntry" role="tab" aria-controls="mark-Entry" aria-selected="true">Mark Entry</a>
               </li>
               <li class="nav-item">
            ...
            <div class="tab-content" id="myTab">
               <div class="tab-pane fade show active" id="markEntry" role="tabpanel" aria-labelledby="mark-Entry">
			   		    <div class="text-center contentDetailTab">Mark Entry </div>
                  <nav class="navbar navbar-light bg-light contentDetailTabNav">
                     <ul class="pagination pagination-sm   mb-0">
                        <li class="page-item"><a  class="page-link page_style svwRecCount"><span class="svwRecCount">{{fnMvwGetCurrentPage('Mark')}}</span></a></li>
                        ...
                        <li class="page-item"><a class="page-link page_style svwRecCount">
                           <span class="svwRecCount">{{fnMvwGetTotalPage('Mark')}}</span></a>
                        </li>
                     </ul>
                     <div>
                     </div>
                     <ul class="pagination pagination-sm justify-content-end mb-0">
                        <li class="page-item"><a id="backwardButton" ng-click="fnMvwBackward('Mark',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-left"></i></span></a></li>
                        <li class="page-item"><a id="forwardButton" ng-click="fnMvwForward('Mark',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-right"></i></span></a></li>
                        <li class="page-item"><a id="addButton" ng-click="fnMvwAddRow('Mark',$event)" class="page-link page_style"> <span class="badge badge-light cohesive_badge"><i class="fas fa-plus"></i></span></a></li>
                        <li class="page-item"><a id="deleteButton" ng-click="fnMvwDeleteRow('Mark',$event)"   
                  ...
                  <div class="table-responsive" id="markEntry">
                   <table class="table  cohesive_table table-sm  table-bordered ">
                        <thead align="center">
                           ...
                           <tr ng-repeat="X in MarkShowObject">
						     <td>
