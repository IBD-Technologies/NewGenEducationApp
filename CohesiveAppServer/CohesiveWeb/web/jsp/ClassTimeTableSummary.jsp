<%-- 
   Document   : ClassTimeTableSummary
   Created on : Jul 30, 2019, 1:32:53 PM
...
<html>
   <head>
      ...
      <script type ="text/javascript" src="/js/ClassTimeTableSummary.js"></script>
   </head>
   <body id="SubScreenCtrl" class="cohesive_body" ng-app="SubScreen" ng-Init="searchShow=false" ng-controller="SubScreenCtrl">
      ...
      <header id="subscreenHeader" class="subscreenHeader mb-3">
         <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
            <h6 align="center">Class Time Table Summary</h6>
      ...
      <div id="subscreenContent" class="subscreenContent">
         ...
         <div id="detailSection" ng-show="!searchShow&&detailshow">
            <div class="text-center contentDetailTab">Class Time Table</div>
            ...
            <div class="table-responsive" id="CTBSummary">
               <table class="table table-striped table-sm table-bordered ">
                  ...
                  <tbody  align="center">
                     <tr ng-repeat="X in ClassTimeTableSummaryShowObject">
                        <td>
