<%-- 
    Document   : TeacherLeaveManagement
    Created on : Jul 18, 2019, 5:10:47 PM
...
--%>
    ...
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <script type="text/javascript" src="/js/TeacherLeaveManagement.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center">Teacher Leave Management</h6>
                ...
                <div id="subscreenContent" class="subscreenContent">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" ng-disabled="teacherNameSearchreadOnly" class="btn btn-primary" ng-click="fnTeacherSearch()"><i class="fas fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <select id="fromNoon" class="custom-select" ng-disabled="fromNoonReadOnly" ng-model="fromNoon">
                    ...
                    <div id="detailSection" ng-show="!searchShow&&detailshow">
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" input-group col-9">
                                <textarea class="form-control" ng-model="audit.CheckerRemarks" readonly></textarea>
                            </div>
                        </div>
                    </div>
