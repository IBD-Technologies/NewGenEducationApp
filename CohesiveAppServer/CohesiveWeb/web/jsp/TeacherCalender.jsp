<%-- 
    Document   : TeacherCalender
    Created on : Jul 18, 2019, 2:24:19 PM
...
--%>
    ...
    <%@page session="false" contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <script type="text/javascript" src="/js/TeacherCalender.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center">Teacher Calender</h6>
                ...
                <div id="subscreenContent" class="subscreenContent">
                    ...
                    <div id="detailSection" ng-show="!searchShow&&detailshow">
					 ...
					 <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active " data-toggle="tab" href="#subDate" role="tab" aria-controls="subDate" aria-selected="true">Date</a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#subEvents" role="tab" aria-controls="subEvents" aria-selected="false">Events</a>
                            </li>
                        </ul>
					     <div class="tab-content">
                            <div class="tab-pane fade show active " id="subDate" role="tabpanel">
					
					 <div id='teacherCalender' ng-model="month">
                        </div>
					</div>
					  <div class="tab-pane fade" id="subEvents" role="tabpanel">
                    </div>
					</div>
					</div>
