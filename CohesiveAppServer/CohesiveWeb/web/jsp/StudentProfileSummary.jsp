<%-- 
   Document   : StudentProfileSummary
   Created on : Jul 29, 2019, 2:03:38 PM
   ...
   --%>
    ...
    <%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix = "c" %>
        ...
        <head>
            ...
            <script type="text/javascript" src="/js/js_library/angular-sanitize.js"></script>
            ...
            <script type="text/javascript" src="/js/StudentProfileSummary.js"></script>
        </head>
         ...
         %>
                <header id="subscreenHeader" class="subscreenHeader mb-3">
                    <div id="subscreenHeading" class="ssHeading" ng-show="!searchShow">
                        <h6 align="center">Student Profile Summary</h6>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    <input id="studName" type="text" ng-readonly="studentNameInputReadOnly" ng-model="studentName" class="form-control">
                ...
                <c:if test="${currentCookie.value.value!='P'}">   
                    ...
                    <div id="detailSection" ng-show="!searchShow&&detailshow">
                        <div class="text-center contentDetailTab">Student Profile </div>
                        <nav class="navbar navbar-light bg-light contentDetailTabNav">
                            <ul class="pagination pagination-sm   mb-0">
                                <li class="page-item"><a class="page-link page_style svwRecCount"><span class="svwRecCount">{{fnMvwGetCurrentPage('StudentProfileSummary')}}</span></a></li>
                                ...
                                <li class="page-item">
                                    <a class="page-link page_style svwRecCount">
                                        <span class="svwRecCount">{{fnMvwGetTotalPage('StudentProfileSummary')}}</span></a>
                                </li>
                            </ul>
                            <div>
                            </div>
                            <ul class="pagination pagination-sm justify-content-end mb-0">
                                <li class="page-item"><a id="backwardButton" ng-click="fnMvwBackward('StudentProfileSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-left"></i></span></a></li>
                                <li class="page-item"><a id="forwardButton" ng-click="fnMvwForward('StudentProfileSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-chevron-right"></i></span></a></li>
                                <li class="page-item">
                                    <a id="addButton" ng-click="fnMvwAddRow('StudentProfileSummary',$event)" class="page-link page_style"> <span class="badge badge-light cohesive_badge"><i class="fas fa-plus"></i></span></a>
                                </li>
                                <li class="page-item"><a id="deleteButton" ng-click="fnMvwDeleteRow('StudentProfileSummary',$event)" class="page-link page_style"><span class="badge badge-light cohesive_badge"><i class="fas fa-minus"></i></span></a></li>
                            </ul>
                        </nav>
                        <div class="table-responsive" id="StudentProfileSummary">
                            <table class="table table-striped table-sm table-bordered ">
                                ...
                                <tbody align="center">
                                    <tr ng-repeat="X in StudentProfileSummaryShowObject">
                                        <td>
