 ...
 * @author DELL
 */
public class TeacherSummaryEntityResource {
    ...
    /**
     * Creates a new instance of TeacherSummaryEntityResource
     */
    private TeacherSummaryEntityResource(String ServiceName) throws NamingException {
    ...
    /**
     * Get instance of the TeacherSummaryEntityResource
     */
    public static TeacherSummaryEntityResource getInstance(String ServiceName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of TeacherSummaryEntityResource class.
        return new TeacherSummaryEntityResource(ServiceName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Gateway.TeacherSummary.TeacherSummaryEntityResource
    ...
    /**
     * PUT method for updating or creating an instance of TeacherSummaryEntityResource
     * @param content representation for the resource
     */
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject TeacherSummaryGateway(JsonObject content) {
        JsonObject response =null;
        try {
            session.createGatewaySessionObject();
            dbg("Inside Teacher summary Gateway Session ID:"+session.getI_session_identifier());
...
//                }
    ...
    /**
     * DELETE method for resource TeacherSummaryEntityResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
