 ...
 * @author DELL
 */
public class UserSummaryEntityResource {
    ...
    /**
     * Creates a new instance of UserSummaryEntityResource
     */
    private UserSummaryEntityResource(String ServiceName) throws NamingException {
    ...
    /**
     * Get instance of the UserSummaryEntityResource
     */
    public static UserSummaryEntityResource getInstance(String ServiceName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of UserSummaryEntityResource class.
        return new UserSummaryEntityResource(ServiceName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Gateway.UserSummary.UserSummaryEntityResource
    ...
    /**
     * PUT method for updating or creating an instance of UserSummaryEntityResource
     * @param content representation for the resource
     */
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject UserSummaryGateway(JsonObject content) {
...
//                }
    ...
    /**
     * DELETE method for resource UserSummaryEntityResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
