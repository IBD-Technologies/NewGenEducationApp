...
public class StudentReportResource {
    ...
    /**
     * Creates a new instance of StudentReportResource
     */
    private StudentReportResource(String ReportName) throws NamingException {
    ...
    /**
     * Get instance of the StudentReportResource
     */
    public static StudentReportResource getInstance(String ReportName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of StudentReportResource class.
        return new StudentReportResource(ReportName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Filter.StudentReportResource
    ...
    /**
     * PUT method for updating or creating an instance of StudentReportResource
     * @param content representation for the resource
     */
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject StudentReport(JsonObject content) {
...
//                }
    ...
    /**
     * DELETE method for resource StudentReportResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
