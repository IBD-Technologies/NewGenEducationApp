...
public class UserResource {
     ...
     */
    private UserResource(String ServiceName) throws NamingException {
     ...
     */
    public static UserResource getInstance(String ServiceName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of UserResource class.
        return new UserResource(ServiceName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Gateway.User.UserResource
    ...
    @Consumes(MediaType.APPLICATION_JSON)
        @Produces(MediaType.APPLICATION_JSON)
    public JsonObject UserGateway(JsonObject content) {
        JsonObject response =null;
        try {
            session.createGatewaySessionObject();
            dbg("Inside User Gateway Session ID:"+session.getI_session_identifier());
