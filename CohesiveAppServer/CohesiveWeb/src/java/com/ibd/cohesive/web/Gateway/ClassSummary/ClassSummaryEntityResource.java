 ...
 * @author DELL
 */
public class ClassSummaryEntityResource {
    ...
    /**
     * Creates a new instance of ClassSummaryEntityResource
     */
    private ClassSummaryEntityResource(String ServiceName) throws NamingException {
    ...
    /**
     * Get instance of the ClassSummaryEntityResource
     */
    public static ClassSummaryEntityResource getInstance(String ServiceName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of ClassSummaryEntityResource class.
        return new ClassSummaryEntityResource(ServiceName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Gateway.ClassSummaryEntity.ClassSummaryEntityResource
    ...
    /**
     * PUT method for updating or creating an instance of ClassSummaryEntityResource
     * @param content representation for the resource
     */
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
   @Produces(MediaType.APPLICATION_JSON)
    public JsonObject ClassSummaryGateway(JsonObject content) {
        JsonObject response =null;
        try {
            session.createSessionObject();
            dbg("Inside Class summary Gateway Session ID:"+session.getI_session_identifier());
...
//                }
    ...
    /**
     * DELETE method for resource ClassSummaryEntityResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
