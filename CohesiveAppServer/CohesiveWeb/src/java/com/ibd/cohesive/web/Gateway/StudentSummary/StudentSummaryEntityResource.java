 ...
 * @author DELL
 */
public class StudentSummaryEntityResource {
    ...
    /**
     * Creates a new instance of StudentSummaryEntityResource
     */
    private StudentSummaryEntityResource(String ServiceName) throws NamingException {
    ...
    /**
     * Get instance of the StudentSummaryEntityResource
     */
    public static StudentSummaryEntityResource getInstance(String ServiceName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of StudentSummaryEntityResource class.
        return new StudentSummaryEntityResource(ServiceName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Gateway.StudentSummary.StudentSummaryEntityResource
    ...
    /**
     * PUT method for updating or creating an instance of StudentSummaryEntityResource
     * @param content representation for the resource
     */
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject StudentSummaryGateway(JsonObject content) {
        JsonObject response =null;
        try {
            session.createGatewaySessionObject();
            dbg("Inside Student summary Gateway Session ID:"+session.getI_session_identifier());
...
//                }
    ...
    /**
     * DELETE method for resource StudentSummaryEntityResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
