...
public class InstituteResource {
    ...
    /**
     * Creates a new instance of InstituteResource
     */
    private InstituteResource(String ServiceName) throws NamingException {
    ...
    /**
     * Get instance of the InstituteResource
     */
    public static InstituteResource getInstance(String ServiceName) throws NamingException {
        // The user may use some kind of persistence mechanism
        // to store and restore instances of InstituteResource class.
        return new InstituteResource(ServiceName);
    }

    /**
     * Retrieves representation of an instance of
     * com.ibd.cohesive.web.Gateway.Institute.InstituteResource
     *
    ...
    /**
     * PUT method for updating or creating an instance of InstituteResource
     *
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject InstituteGateway(JsonObject content) {
...
//                }
    ...
    /**
     * DELETE method for resource InstituteResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
