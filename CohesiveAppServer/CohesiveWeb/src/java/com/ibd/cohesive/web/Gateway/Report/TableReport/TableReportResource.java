 ...
 * @author DELL
 */
public class TableReportResource {
    ...
    /**
     * Creates a new instance of TableReportResource
     */
    private TableReportResource(String ReportName)throws NamingException {
    ...
    /**
     * Get instance of the TableReportResource
     */
    public static TableReportResource getInstance(String ReportName) throws NamingException{
        // The user may use some kind of persistence mechanism
        // to store and restore instances of TableReportResource class.
        return new TableReportResource(ReportName);
    }

    /**
     * Retrieves representation of an instance of com.ibd.cohesive.web.Gateway.Report.TableReport.TableReportResource
    ...
    /**
     * PUT method for updating or creating an instance of TableReportResource
     * @param content representation for the resource
     */
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject TableReport(JsonObject content) {
        
         JsonObject response =null;
        try {
            session.createGatewaySessionObject();
            dbg("Inside Table Report Gateway Session ID:"+session.getI_session_identifier());
...
//                }
    ...
    /**
     * DELETE method for resource TableReportResource
     */
    @DELETE
    public void delete() {
        throw new UnsupportedOperationException();
