...
public class BATCH_CONFIG {
    ...
    String START_TIME;
    String EOD;
    String INTRA_DAY_BATCH;
    String REC_FAIL;
    String NO_OF_THREADS;
    String CHILD_NO_OF_THREADS;
    String MAKER_ID;
    String CHECKER_ID;
    ...
    public String getINTRA_DAY_BATCH() {
        return INTRA_DAY_BATCH;
    }

    public void setINTRA_DAY_BATCH(String INTRA_DAY_BATCH) {
        this.INTRA_DAY_BATCH = INTRA_DAY_BATCH;
    }
    ...
    public void setREC_FAIL(String REC_FAIL) {
        this.REC_FAIL = REC_FAIL;
    }

    public String getNO_OF_THREADS() {
        return NO_OF_THREADS;
    }

    public void setNO_OF_THREADS(String NO_OF_THREADS) {
        this.NO_OF_THREADS = NO_OF_THREADS;
    }

    public String getCHILD_NO_OF_THREADS() {
        return CHILD_NO_OF_THREADS;
    }

    public void setCHILD_NO_OF_THREADS(String CHILD_NO_OF_THREADS) {
        this.CHILD_NO_OF_THREADS = CHILD_NO_OF_THREADS;
    }
    ...
    public ArrayList<BATCH_CONFIG>convertStringToArrayList(String result){
        
          ArrayList<BATCH_CONFIG> BATCH_CONFIGList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              BATCH_CONFIG appStatus=new BATCH_CONFIG();
              ...
              appStatus.setCHILD_NO_OF_THREADS(record.split("~")[5]);
              appStatus.setEOD(record.split("~")[6]);
              appStatus.setEXECUTION_FREQUENCY(record.split("~")[7]);
              appStatus.setINTRA_DAY_BATCH(record.split("~")[8]);
              appStatus.setLAYER(record.split("~")[9]);
              ...
              appStatus.setNO_OF_THREADS(record.split("~")[13]);
              appStatus.setRECORD_STATUS(record.split("~")[14]);
              appStatus.setREC_FAIL(record.split("~")[15]);
              appStatus.setSTART_TIME(record.split("~")[16]);
           ...
           BATCH_CONFIGList.add(appStatus);
          }
          
        return BATCH_CONFIGList;
