 ...
 * @author ibdtech
 */
public class E_CIRCULAR_EOD_STATUS {
    String INSTITUTE_ID;
    ...
    public ArrayList<E_CIRCULAR_EOD_STATUS>convertStringToArrayList(String result){
        
          ArrayList<E_CIRCULAR_EOD_STATUS> E_CIRCULAR_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              E_CIRCULAR_EOD_STATUS appStatus=new E_CIRCULAR_EOD_STATUS();
              ...
              E_CIRCULAR_EOD_STATUSList.add(appStatus);
          }
          
          
          return E_CIRCULAR_EOD_STATUSList;
      }
}
