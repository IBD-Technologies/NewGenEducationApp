 ...
 * @author DELL
 */
public class ATTENDANCE_BATCH_STATUS_DataSource extends BatchDataSource<ATTENDANCE_BATCH_STATUS>{

    String businessDate;
    
    @Override
      public List<ATTENDANCE_BATCH_STATUS> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getATTENDANCE_BATCH_STATUS_DataSet(businessDate);  
