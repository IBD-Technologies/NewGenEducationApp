...
public class OTHER_ACTIVITY_EOD_STATUS {
    ...
    public ArrayList<OTHER_ACTIVITY_EOD_STATUS>convertStringToArrayList(String result){
        
          ArrayList<OTHER_ACTIVITY_EOD_STATUS> OTHER_ACTIVITY_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              OTHER_ACTIVITY_EOD_STATUS appStatus=new OTHER_ACTIVITY_EOD_STATUS();
              ...
              OTHER_ACTIVITY_EOD_STATUSList.add(appStatus);
          }
          
          
          return OTHER_ACTIVITY_EOD_STATUSList;
      }
