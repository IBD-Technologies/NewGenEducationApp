...
public class FEE_EOD_STATUS {
    ...
    public void setEND_TIME(String END_TIME) {
     ...
     public ArrayList<FEE_EOD_STATUS>convertStringToArrayList(String result){
        
          ArrayList<FEE_EOD_STATUS> FEE_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              FEE_EOD_STATUS appStatus=new FEE_EOD_STATUS();
              ...
              FEE_EOD_STATUSList.add(appStatus);
          }
          
          
          return FEE_EOD_STATUSList;
      }
