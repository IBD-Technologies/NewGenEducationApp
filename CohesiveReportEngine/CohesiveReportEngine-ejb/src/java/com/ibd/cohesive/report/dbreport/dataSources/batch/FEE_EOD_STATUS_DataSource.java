 ...
 * @author DELL
 */
public class FEE_EOD_STATUS_DataSource extends BatchDataSource<FEE_EOD_STATUS>{

    String businessDate;
    String instituteID;
    
    @Override
      public List<FEE_EOD_STATUS> fetch()
	{
...
//                return batchDataSet.getNOTIFICATION_EOD_STATUS_DataSet(businessDate);  
                ...
                List<FEE_EOD_STATUS> resultset=null;
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= batchDataSet.getFEE_EOD_STATUS_DataSet(businessDate,instituteID);
                  FEE_EOD_STATUS obj=new FEE_EOD_STATUS();
