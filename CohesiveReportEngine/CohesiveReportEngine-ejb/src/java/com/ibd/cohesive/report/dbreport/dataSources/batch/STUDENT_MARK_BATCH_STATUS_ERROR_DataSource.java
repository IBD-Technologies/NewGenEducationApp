 ...
 * @author DELL
 */
public class STUDENT_MARK_BATCH_STATUS_ERROR_DataSource extends BatchDataSource<STUDENT_MARK_BATCH_STATUS_ERROR>{

    String businessDate;
    
    @Override
      public List<STUDENT_MARK_BATCH_STATUS_ERROR> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_MARK_BATCH_STATUS_ERROR_DataSet(businessDate);  
