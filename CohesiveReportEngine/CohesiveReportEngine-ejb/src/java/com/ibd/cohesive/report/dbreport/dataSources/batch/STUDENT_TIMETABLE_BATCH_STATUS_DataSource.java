 ...
 * @author DELL
 */
public class STUDENT_TIMETABLE_BATCH_STATUS_DataSource extends BatchDataSource<STUDENT_TIMETABLE_BATCH_STATUS>{

    String businessDate;
    
    @Override
      public List<STUDENT_TIMETABLE_BATCH_STATUS> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_TIMETABLE_BATCH_STATUS_DataSet(businessDate);  
