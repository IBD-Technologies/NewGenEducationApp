 ...
 * @author DELL
 */
public class STUDENT_NOTIFICATION_EOD_STATUS_ERROR {
    String INSTITUTE_ID;
    ...
    public void setERROR(String ERROR) {
      ...
      public ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_ERROR>convertStringToArrayList(String result){
        
          ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_ERROR> STUDENT_NOTIFICATION_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              STUDENT_NOTIFICATION_EOD_STATUS_ERROR appStatus=new STUDENT_NOTIFICATION_EOD_STATUS_ERROR();
