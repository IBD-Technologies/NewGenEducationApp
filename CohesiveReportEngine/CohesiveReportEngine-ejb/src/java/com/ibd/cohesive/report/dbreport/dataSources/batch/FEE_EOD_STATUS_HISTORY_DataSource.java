...
import com.ibd.cohesive.report.dbreport.dataSource.dataModels.batch.FEE_EOD_STATUS;
import com.ibd.cohesive.report.dbreport.dataSource.dataModels.batch.FEE_EOD_STATUS_HISTORY;
...
public class FEE_EOD_STATUS_HISTORY_DataSource  extends BatchDataSource<FEE_EOD_STATUS_HISTORY>{
    ...
    @Override
      public List<FEE_EOD_STATUS_HISTORY> fetch()
	{
...
//                return batchDataSet.getNOTIFICATION_EOD_STATUS_DataSet(businessDate);  
                ...
                List<FEE_EOD_STATUS_HISTORY> resultset=null;
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= batchDataSet.getFEE_EOD_STATUS_HISTORY_DataSet(businessDate,instituteID);
                  FEE_EOD_STATUS_HISTORY obj=new FEE_EOD_STATUS_HISTORY();
