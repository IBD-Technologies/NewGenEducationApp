 ...
 * @author DELL
 */
public class STUDENT_FEE_EOD_STATUS_HISTORY {
    String INSTITUTE_ID;
    String FEE_ID;
    String STUDENT_ID;
    ...
    public void setSEQUENCE_NO(String SEQUENCE_NO) {
        ...
        public ArrayList<STUDENT_FEE_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<STUDENT_FEE_EOD_STATUS_HISTORY> STUDENT_FEE_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              STUDENT_FEE_EOD_STATUS_HISTORY appStatus=new STUDENT_FEE_EOD_STATUS_HISTORY();
              ...
              STUDENT_FEE_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return STUDENT_FEE_EOD_STATUS_HISTORYList;
      } 
