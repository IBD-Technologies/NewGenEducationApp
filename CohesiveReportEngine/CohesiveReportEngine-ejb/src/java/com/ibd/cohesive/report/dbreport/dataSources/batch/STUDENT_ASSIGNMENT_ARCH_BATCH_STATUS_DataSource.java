 ...
 * @author DELL
 */
public class STUDENT_ASSIGNMENT_ARCH_BATCH_STATUS_DataSource extends BatchDataSource<STUDENT_ASSIGNMENT_ARCH_BATCH_STATUS>{

    String businessDate;
    
    @Override
      public List<STUDENT_ASSIGNMENT_ARCH_BATCH_STATUS> fetch()
	{
            ...
            try
            {
                ...
                System.out.print("business date inside STUDENT_ASSIGNMENT_ARCH_BATCH_STATUS_DataSource"+businessDate);
                ...
                return batchDataSet.getSTUDENT_ASSIGNMENT_ARCH_BATCH_STATUS_DataSet(businessDate);  
