...
import com.ibd.cohesive.report.businessreport.datSources.dataModels.classEntity.ClassDetails;
 ...
 * @author DELL
 */
public class ClassDetails_DataSource extends ClassDataSource<ClassDetails>{
    ...
    @Override
      public List<ClassDetails> fetch()
	{
            ...
            try
            {
                ...
                instanceID =this.getLoginInstitute();
                 ...
                 ArrayList<ClassDetails> resultset=null;
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= batchDataSet.getClassDetails_DataSet(standard, section, instanceID);
