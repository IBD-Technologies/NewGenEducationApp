 ...
 */
public class TVW_TEACHER_CALENDER {
    String TEACHER_ID;
    String YEAR;
    String MONTH;
    String DATE;
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
     ...
     public ArrayList<TVW_TEACHER_CALENDER>convertStringToArrayList(String result){
        
          ArrayList<TVW_TEACHER_CALENDER> TVW_TEACHER_CALENDERList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              TVW_TEACHER_CALENDER appStatus=new TVW_TEACHER_CALENDER();
              ...
              appStatus.setEVENTS(record.split("~")[5]);
              appStatus.setMAKER_DATE_STAMP(record.split("~")[6]);
              appStatus.setMAKER_ID(record.split("~")[7]);             
              appStatus.setMAKER_REMARKS(record.split("~")[8]);
              appStatus.setMONTH(record.split("~")[9]);
              appStatus.setRECORD_STATUS(record.split("~")[10]);
              appStatus.setTEACHER_ID(record.split("~")[11]);  
              appStatus.setVERSION_NUMBER(record.split("~")[12]);
              appStatus.setYEAR(record.split("~")[13]);             
           ...
           TVW_TEACHER_CALENDERList.add(appStatus);
          }
          
        return TVW_TEACHER_CALENDERList;
