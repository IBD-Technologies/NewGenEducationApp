 ...
 * @author DELL
 */
public class STUDENT_TIMETABLE_BATCH_STATUS_ERROR_DataSource extends BatchDataSource<STUDENT_TIMETABLE_BATCH_STATUS_ERROR>{

    String businessDate;
    
    @Override
      public List<STUDENT_TIMETABLE_BATCH_STATUS_ERROR> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_TIMETABLE_BATCH_STATUS_ERROR_DataSet(businessDate);  
