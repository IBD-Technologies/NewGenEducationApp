 ...
 * @author DELL
 */
public class OTHER_ACTIVITY_EOD_STATUS_HISTORY {
    String INSTITUTE_ID;
    String ACTIVITY_ID;
  ...
  public ArrayList<OTHER_ACTIVITY_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<OTHER_ACTIVITY_EOD_STATUS_HISTORY> OTHER_ACTIVITY_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              OTHER_ACTIVITY_EOD_STATUS_HISTORY appStatus=new OTHER_ACTIVITY_EOD_STATUS_HISTORY();
              ...
              OTHER_ACTIVITY_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return OTHER_ACTIVITY_EOD_STATUS_HISTORYList;
      }   
