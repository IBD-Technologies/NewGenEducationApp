 ...
 */
public class SVW_STUDENT_MARKS {
    String STUDENT_ID;
    String EXAM;
    String SUBJECT_ID;
    String GRADE;
    ...
    public void setVERSION_NUMBER(String VERSION_NUMBER) {
       ...
       public ArrayList<SVW_STUDENT_MARKS>convertStringToArrayList(String result){
        
          ArrayList<SVW_STUDENT_MARKS> SVW_STUDENT_MARKSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_STUDENT_MARKS appStatus=new SVW_STUDENT_MARKS();
           ...
           SVW_STUDENT_MARKSList.add(appStatus);
          }
          
        return SVW_STUDENT_MARKSList;
