 ...
 */
public class SVW_STUDENT_LEAVE_MANAGEMENT_DataSource extends StudentDataSource<SVW_STUDENT_LEAVE_MANAGEMENT>{
    String fileName;
    String instanceID;
    
    @Override
      public List<SVW_STUDENT_LEAVE_MANAGEMENT> fetch()
	{
            ...
            try
            {
               //parseParameters();
                ...
                ArrayList<SVW_STUDENT_LEAVE_MANAGEMENT> resultset=new ArrayList();
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= appDataSet.getSVW_STUDENT_LEAVE_MANAGEMENT_DataSet(fileName, instanceID);
                  
                  SVW_STUDENT_LEAVE_MANAGEMENT errorMaster=new SVW_STUDENT_LEAVE_MANAGEMENT();
