...
import com.ibd.cohesive.report.dbreport.dataSource.dataModels.batch.ASSIGNMENT_EOD_STATUS_HISTORY;
...
//                return batchDataSet.getASSIGNMENT_EOD_STATUS_HISTORY_DataSet(businessDate);  
                  ArrayList<ASSIGNMENT_EOD_STATUS_HISTORY> resultset=null;
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= batchDataSet.getASSIGNMENT_EOD_STATUS_HISTORY_DataSet(businessDate, instituteID);
                  ASSIGNMENT_EOD_STATUS_HISTORY obj=new ASSIGNMENT_EOD_STATUS_HISTORY();
