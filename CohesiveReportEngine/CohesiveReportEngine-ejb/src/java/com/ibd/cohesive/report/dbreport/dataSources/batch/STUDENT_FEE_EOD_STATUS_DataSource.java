...
import com.ibd.cohesive.report.dbreport.dataSource.dataModels.batch.STUDENT_FEE_EOD_STATUS;
 ...
 * @author DELL
 */
public class STUDENT_FEE_EOD_STATUS_DataSource extends BatchDataSource<STUDENT_FEE_EOD_STATUS>{

    String businessDate;
    String instituteID;
    
    @Override
      public List<STUDENT_FEE_EOD_STATUS> fetch()
	{
...
//                return batchDataSet.getNOTIFICATION_EOD_STATUS_DataSet(businessDate);  
                ...
                List<STUDENT_FEE_EOD_STATUS> resultset=null;
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= batchDataSet.getSTUDENT_FEE_EOD_STATUS_DataSet(businessDate,instituteID);
                  STUDENT_FEE_EOD_STATUS obj=new STUDENT_FEE_EOD_STATUS();
