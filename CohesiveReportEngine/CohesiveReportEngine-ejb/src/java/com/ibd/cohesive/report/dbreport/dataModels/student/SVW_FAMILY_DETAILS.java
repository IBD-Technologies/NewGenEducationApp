 ...
 */
public class SVW_FAMILY_DETAILS {
    String STUDENT_ID;
    String MEMBER_ID;
    String MEMBER_NAME;
    ...
    public void setVERSION_NUMBER(String VERSION_NUMBER) {
     ...
     public ArrayList<SVW_FAMILY_DETAILS>convertStringToArrayList(String result){
        
          ArrayList<SVW_FAMILY_DETAILS> SVW_FAMILY_DETAILSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_FAMILY_DETAILS appStatus=new SVW_FAMILY_DETAILS();
           ...
           SVW_FAMILY_DETAILSList.add(appStatus);
          }
          
        return SVW_FAMILY_DETAILSList;
