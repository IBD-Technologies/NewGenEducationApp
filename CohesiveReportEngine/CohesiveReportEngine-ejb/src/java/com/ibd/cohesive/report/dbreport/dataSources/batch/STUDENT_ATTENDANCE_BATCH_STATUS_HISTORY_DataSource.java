 ...
 * @author DELL
 */
public class STUDENT_ATTENDANCE_BATCH_STATUS_HISTORY_DataSource extends BatchDataSource<STUDENT_ATTENDANCE_BATCH_STATUS_HISTORY>{

    String businessDate;
    
    @Override
      public List<STUDENT_ATTENDANCE_BATCH_STATUS_HISTORY> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_ATTENDANCE_BATCH_STATUS_HISTORY_DataSet(businessDate);  
