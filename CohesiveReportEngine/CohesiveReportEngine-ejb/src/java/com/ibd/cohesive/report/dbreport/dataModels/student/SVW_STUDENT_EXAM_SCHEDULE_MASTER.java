 ...
 */
public class SVW_STUDENT_EXAM_SCHEDULE_MASTER {
    String STUDENT_ID;
String EXAM;
String MAKER_ID;
String CHECKER_ID;
...
String CHECKER_REMARKS;
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
       ...
       public ArrayList<SVW_STUDENT_EXAM_SCHEDULE_MASTER>convertStringToArrayList(String result){
        
          ArrayList<SVW_STUDENT_EXAM_SCHEDULE_MASTER> SVW_STUDENT_EXAM_SCHEDULE_MASTERList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_STUDENT_EXAM_SCHEDULE_MASTER appStatus=new SVW_STUDENT_EXAM_SCHEDULE_MASTER();
              ...
              appStatus.setSTUDENT_ID(record.split("~")[9]);
           ...
           SVW_STUDENT_EXAM_SCHEDULE_MASTERList.add(appStatus);
          }
          
        return SVW_STUDENT_EXAM_SCHEDULE_MASTERList;
