 ...
 * @author DELL
 */
public class FEE_EOD_STATUS_HISTORY {
    String INSTITUTE_ID;
    String FEE_ID;
    ...
    public ArrayList<FEE_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<FEE_EOD_STATUS_HISTORY> FEE_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              FEE_EOD_STATUS_HISTORY appStatus=new FEE_EOD_STATUS_HISTORY();
              ...
              FEE_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return FEE_EOD_STATUS_HISTORYList;
      } 
}
