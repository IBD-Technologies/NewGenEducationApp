...
public class BATCH_STATUS {
    ...
    public ArrayList<BATCH_STATUS>convertStringToArrayList(String result){
        
          ArrayList<BATCH_STATUS> BATCH_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              BATCH_STATUS appStatus=new BATCH_STATUS();
              ...
              BATCH_STATUSList.add(appStatus);
          }
          
          
          return BATCH_STATUSList;
     }
