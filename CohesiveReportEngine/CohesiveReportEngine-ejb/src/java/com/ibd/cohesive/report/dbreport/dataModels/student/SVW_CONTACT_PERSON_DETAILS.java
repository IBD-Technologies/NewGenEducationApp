 ...
 */
public class SVW_CONTACT_PERSON_DETAILS {
    String STUDENT_ID;
    String CP_ID;
    String CP_NAME;
    ...
    public void setVERSION_NUMBER(String VERSION_NUMBER) {
     ...
     public ArrayList<SVW_CONTACT_PERSON_DETAILS>convertStringToArrayList(String result){
        
          ArrayList<SVW_CONTACT_PERSON_DETAILS> SVW_CONTACT_PERSON_DETAILSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_CONTACT_PERSON_DETAILS appStatus=new SVW_CONTACT_PERSON_DETAILS();
           ...
           SVW_CONTACT_PERSON_DETAILSList.add(appStatus);
          }
          
        return SVW_CONTACT_PERSON_DETAILSList;
