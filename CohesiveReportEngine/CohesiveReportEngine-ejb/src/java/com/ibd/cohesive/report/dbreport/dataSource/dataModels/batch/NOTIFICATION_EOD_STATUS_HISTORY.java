...
public class NOTIFICATION_EOD_STATUS_HISTORY {
    ...
    public ArrayList<NOTIFICATION_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<NOTIFICATION_EOD_STATUS_HISTORY> NOTIFICATION_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              NOTIFICATION_EOD_STATUS_HISTORY appStatus=new NOTIFICATION_EOD_STATUS_HISTORY();
              
              appStatus.setBUSINESS_DATE(record.split("~")[0]);
              appStatus.setEND_TIME(record.split("~")[1]);
              appStatus.setERROR(record.split("~")[2]);
              appStatus.setGROUP_ID(record.split("~")[3]);
              appStatus.setINSTITUTE_ID(record.split("~")[4]);
              appStatus.setNOTIFICATION_ID(record.split("~")[5]);
              ...
              NOTIFICATION_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return NOTIFICATION_EOD_STATUS_HISTORYList;
      }
