...
public class SubstituteAvailabilityInOtherClass {
    ...
    public void setTeacherID(String TeacherID) {
     ...
     public ArrayList<SubstituteAvailabilityInOtherClass>convertStringToArrayList(String result){
        
          ArrayList<SubstituteAvailabilityInOtherClass> SubstituteAvailabilityInOtherClassList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SubstituteAvailabilityInOtherClass appStatus=new SubstituteAvailabilityInOtherClass();
              ...
              SubstituteAvailabilityInOtherClassList.add(appStatus);
          }
          
          
          return SubstituteAvailabilityInOtherClassList;
