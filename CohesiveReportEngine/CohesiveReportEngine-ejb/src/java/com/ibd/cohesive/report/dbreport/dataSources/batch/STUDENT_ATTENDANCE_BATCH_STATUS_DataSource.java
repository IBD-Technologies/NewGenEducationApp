 ...
 * @author DELL
 */
public class STUDENT_ATTENDANCE_BATCH_STATUS_DataSource extends BatchDataSource<STUDENT_ATTENDANCE_BATCH_STATUS>{

    String businessDate;
    
    @Override
      public List<STUDENT_ATTENDANCE_BATCH_STATUS> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_ATTENDANCE_BATCH_STATUS_DataSet(businessDate);  
