 ...
 * @author DELL
 */
public class TVW_CONTACT_PERSON_DETAILS_BUSINESS {
    String TEACHER_ID;
    String CP_ID;
    String CP_NAME;
    ...
    public ArrayList<TVW_CONTACT_PERSON_DETAILS_BUSINESS>convertStringToArrayList(String result){
        
          ArrayList<TVW_CONTACT_PERSON_DETAILS_BUSINESS> TVW_CONTACT_PERSON_DETAILS_BUSINESSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              TVW_CONTACT_PERSON_DETAILS_BUSINESS appStatus=new TVW_CONTACT_PERSON_DETAILS_BUSINESS();
           ...
           TVW_CONTACT_PERSON_DETAILS_BUSINESSList.add(appStatus);
          }
          
        return TVW_CONTACT_PERSON_DETAILS_BUSINESSList;
