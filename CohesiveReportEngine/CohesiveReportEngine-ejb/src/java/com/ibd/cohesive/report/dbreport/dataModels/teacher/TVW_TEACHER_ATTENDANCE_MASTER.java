 ...
 */
public class TVW_TEACHER_ATTENDANCE_MASTER {
    String TEACHER_ID;
    String DATE;
    String MAKER_ID;
    String CHECKER_ID;
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
     ...
     public ArrayList<TVW_TEACHER_ATTENDANCE_MASTER>convertStringToArrayList(String result){
        
          ArrayList<TVW_TEACHER_ATTENDANCE_MASTER> TVW_TEACHER_ATTENDANCE_MASTERList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              TVW_TEACHER_ATTENDANCE_MASTER appStatus=new TVW_TEACHER_ATTENDANCE_MASTER();
              ...
              appStatus.setTEACHER_ID(record.split("~")[9]);
           ...
           TVW_TEACHER_ATTENDANCE_MASTERList.add(appStatus);
          }
          
        return TVW_TEACHER_ATTENDANCE_MASTERList;
