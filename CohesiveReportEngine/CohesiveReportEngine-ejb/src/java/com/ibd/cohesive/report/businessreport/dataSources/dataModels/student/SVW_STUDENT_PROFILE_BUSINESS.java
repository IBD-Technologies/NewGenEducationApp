 ...
 * @author DELL
 */
public class SVW_STUDENT_PROFILE_BUSINESS {
    String STUDENT_ID;
    String STUDENT_NAME;
    String STANDARD;
    String SECTION;
    ...
    public void setEXISTING_MEDICAL_DETAIL(String EXISTING_MEDICAL_DETAIL) {
     ...
     public ArrayList<SVW_STUDENT_PROFILE_BUSINESS>convertStringToArrayList(String result){
        
          ArrayList<SVW_STUDENT_PROFILE_BUSINESS> SVW_STUDENT_PROFILE_BUSINESSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_STUDENT_PROFILE_BUSINESS appStatus=new SVW_STUDENT_PROFILE_BUSINESS();
              ...
              appStatus.setBLOODGROUP(record.split("~")[6]);
              ...
              appStatus.setDOB(record.split("~")[10]);
              appStatus.setEXISTING_MEDICAL_DETAIL(record.split("~")[11]);
              appStatus.setIMAGE_PATH(record.split("~")[12]);
              appStatus.setMAKER_DATE_STAMP(record.split("~")[13]);
              appStatus.setMAKER_ID(record.split("~")[14]);
              appStatus.setMAKER_REMARKS(record.split("~")[15]);
              appStatus.setNOTES(record.split("~")[16]);
              appStatus.setRECORD_STATUS(record.split("~")[17]);
              appStatus.setSECTION(record.split("~")[18]);
              appStatus.setSTANDARD(record.split("~")[19]);
              appStatus.setSTUDENT_ID(record.split("~")[20]);
              appStatus.setSTUDENT_NAME(record.split("~")[21]);
              appStatus.setVERSION_NUMBER(record.split("~")[22]);
              
              SVW_STUDENT_PROFILE_BUSINESSList.add(appStatus);
          }
          
          
          return SVW_STUDENT_PROFILE_BUSINESSList;
