 ...
 * @author DELL
 */
public class TIMETABLE_BATCH_STATUS_HISTORY_DataSource extends BatchDataSource<TIMETABLE_BATCH_STATUS_HISTORY>{

    String businessDate;
    
    @Override
      public List<TIMETABLE_BATCH_STATUS_HISTORY> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getTIMETABLE_BATCH_STATUS_HISTORY_DataSet(businessDate);  
