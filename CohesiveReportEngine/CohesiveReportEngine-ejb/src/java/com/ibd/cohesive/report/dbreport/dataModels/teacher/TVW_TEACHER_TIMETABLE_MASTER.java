 ...
 */
public class TVW_TEACHER_TIMETABLE_MASTER {
    String TEACHER_ID;
    String MAKER_ID;
    String CHECKER_ID;
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
     ...
     public ArrayList<TVW_TEACHER_TIMETABLE_MASTER>convertStringToArrayList(String result){
        
          ArrayList<TVW_TEACHER_TIMETABLE_MASTER> TVW_TEACHER_TIMETABLE_MASTERList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              TVW_TEACHER_TIMETABLE_MASTER appStatus=new TVW_TEACHER_TIMETABLE_MASTER();
           ...
           TVW_TEACHER_TIMETABLE_MASTERList.add(appStatus);
          }
          
        return TVW_TEACHER_TIMETABLE_MASTERList;
