 ...
 * @author DELL
 */
public class STUDENT_ATTENDANCE_BATCH_STATUS_ERROR_DataSource extends BatchDataSource<STUDENT_ATTENDANCE_BATCH_STATUS_ERROR>{

    String businessDate;
    
    @Override
      public List<STUDENT_ATTENDANCE_BATCH_STATUS_ERROR> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_ATTENDANCE_BATCH_STATUS_ERROR_DataSet(businessDate);  
