 ...
 * @author DELL
 */
public class STUDENT_NOTIFICATION_EOD_STATUS {
    String INSTITUTE_ID;
    ...
    public ArrayList<STUDENT_NOTIFICATION_EOD_STATUS>convertStringToArrayList(String result){
        
          ArrayList<STUDENT_NOTIFICATION_EOD_STATUS> STUDENT_NOTIFICATION_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              STUDENT_NOTIFICATION_EOD_STATUS appStatus=new STUDENT_NOTIFICATION_EOD_STATUS();
