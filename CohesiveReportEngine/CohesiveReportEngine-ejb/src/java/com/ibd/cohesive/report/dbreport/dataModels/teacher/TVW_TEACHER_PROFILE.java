 ...
 */
public class TVW_TEACHER_PROFILE {
    String TEACHER_ID;
    String TEACHER_NAME;
 ...
 public ArrayList<TVW_TEACHER_PROFILE>convertStringToArrayList(String result){
        
          ArrayList<TVW_TEACHER_PROFILE> TVW_TEACHER_PROFILEList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              TVW_TEACHER_PROFILE appStatus=new TVW_TEACHER_PROFILE();
              ...
              appStatus.setSECTION(record.split("~")[19]);
              appStatus.setSHORT_NAME(record.split("~")[20]);
              appStatus.setSTANDARD(record.split("~")[21]);
              appStatus.setTEACHER_ID(record.split("~")[22]);
              appStatus.setTEACHER_NAME(record.split("~")[23]);
              appStatus.setVERSION_NUMBER(record.split("~")[24]);
           ...
           TVW_TEACHER_PROFILEList.add(appStatus);
          }
          
        return TVW_TEACHER_PROFILEList;
