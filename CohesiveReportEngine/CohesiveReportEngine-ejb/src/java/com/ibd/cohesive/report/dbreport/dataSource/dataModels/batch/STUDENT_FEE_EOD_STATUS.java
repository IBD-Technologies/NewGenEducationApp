 ...
 * @author DELL
 */
public class STUDENT_FEE_EOD_STATUS {
    String INSTITUTE_ID;
    String FEE_ID;
    String STUDENT_ID;
    ...
    public ArrayList<STUDENT_FEE_EOD_STATUS>convertStringToArrayList(String result){
        
          ArrayList<STUDENT_FEE_EOD_STATUS> STUDENT_FEE_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              STUDENT_FEE_EOD_STATUS appStatus=new STUDENT_FEE_EOD_STATUS();
              ...
              STUDENT_FEE_EOD_STATUSList.add(appStatus);
          }
          
          
          return STUDENT_FEE_EOD_STATUSList;
      }
