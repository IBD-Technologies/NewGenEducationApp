...
public class INSTITUTE_EOD_STATUS_HISTORY {
    ...
    public void setSEQUENCE_NO(String SEQUENCE_NO) {
      ...
      public ArrayList<INSTITUTE_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<INSTITUTE_EOD_STATUS_HISTORY> INSTITUTE_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              INSTITUTE_EOD_STATUS_HISTORY appStatus=new INSTITUTE_EOD_STATUS_HISTORY();
              ...
              INSTITUTE_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return INSTITUTE_EOD_STATUS_HISTORYList;
      }  
