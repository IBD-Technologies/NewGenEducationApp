 ...
 */
public class SVW_STUDENT_PROFILE {
    String STUDENT_ID;
    String STUDENT_NAME;
    String STANDARD;
    String SECTION;
    ...
    public void setEXISTING_MEDICAL_DETAIL(String EXISTING_MEDICAL_DETAIL) {
       ...
       public ArrayList<SVW_STUDENT_PROFILE>convertStringToArrayList(String result){
        
          ArrayList<SVW_STUDENT_PROFILE> SVW_STUDENT_PROFILEList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_STUDENT_PROFILE appStatus=new SVW_STUDENT_PROFILE();
           ...
           SVW_STUDENT_PROFILEList.add(appStatus);
          }
          
        return SVW_STUDENT_PROFILEList;
