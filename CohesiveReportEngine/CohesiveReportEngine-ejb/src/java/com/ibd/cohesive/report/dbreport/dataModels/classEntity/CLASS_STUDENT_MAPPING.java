 ...
 */
public class CLASS_STUDENT_MAPPING {
    String STANDARD;
    String SECTION;
    String STUDENT_ID;
    String MAKER_ID;
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
     ...
     public ArrayList<CLASS_STUDENT_MAPPING>convertStringToArrayList(String result){
        
          ArrayList<CLASS_STUDENT_MAPPING> CLASS_STUDENT_MAPPINGList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              CLASS_STUDENT_MAPPING appStatus=new CLASS_STUDENT_MAPPING();
           ...
           CLASS_STUDENT_MAPPINGList.add(appStatus);
          }
          
        return CLASS_STUDENT_MAPPINGList;
