 ...
 * @author DELL
 */
public class EXAM_BATCH_STATUS_DataSource extends BatchDataSource<EXAM_BATCH_STATUS>{

    String businessDate;
    
    @Override
      public List<EXAM_BATCH_STATUS> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getEXAM_BATCH_STATUS_DataSet(businessDate);  
