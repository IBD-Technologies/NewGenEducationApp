 ...
 */
public class CLASS_TIMETABLE_MASTER_DataSource extends ClassDataSource<CLASS_TIMETABLE_MASTER>{
    ...
    @Override
      public List<CLASS_TIMETABLE_MASTER> fetch()
	{
            ...
            try
            {
              standard = this.getStandard();
                ...
                ArrayList<CLASS_TIMETABLE_MASTER> resultset=new ArrayList();
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= appDataSet.getCLASS_TIMETABLE_MASTER_DataSet(standard,section,instanceID);
                  
                  CLASS_TIMETABLE_MASTER errorMaster=new CLASS_TIMETABLE_MASTER();
