 ...
 * @author DELL
 */
public class OTHER_ACTIVITY_EOD_STATUS_ERROR_DataSource extends BatchDataSource<OTHER_ACTIVITY_EOD_STATUS_ERROR>{

    String businessDate;
    String instituteID;
    
    @Override
      public List<OTHER_ACTIVITY_EOD_STATUS_ERROR> fetch()
	{
...
//                return batchDataSet.getNOTIFICATION_EOD_STATUS_DataSet(businessDate);  
                ...
                List<OTHER_ACTIVITY_EOD_STATUS_ERROR> resultset=null;
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= batchDataSet.getOTHER_ACTIVITY_EOD_STATUS_ERROR_DataSet(businessDate,instituteID);
                  OTHER_ACTIVITY_EOD_STATUS_ERROR obj=new OTHER_ACTIVITY_EOD_STATUS_ERROR();
