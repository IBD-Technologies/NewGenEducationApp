 ...
 * @author DELL
 */
public class STUDENT_MARK_BATCH_STATUS_HISTORY_DataSource extends BatchDataSource<STUDENT_MARK_BATCH_STATUS_HISTORY>{

    String businessDate;
    
    @Override
      public List<STUDENT_MARK_BATCH_STATUS_HISTORY> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_MARK_BATCH_STATUS_HISTORY_DataSet(businessDate);  
