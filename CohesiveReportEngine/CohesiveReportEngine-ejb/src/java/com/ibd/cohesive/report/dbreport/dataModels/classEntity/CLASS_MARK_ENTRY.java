...
public class CLASS_MARK_ENTRY {
    ...
    public void setCHECKER_REMARKS(String CHECKER_REMARKS) {
     ...
     public ArrayList<CLASS_MARK_ENTRY>convertStringToArrayList(String result){
        
          ArrayList<CLASS_MARK_ENTRY> CLASS_MARK_ENTRYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              CLASS_MARK_ENTRY appStatus=new CLASS_MARK_ENTRY();
              ...
              appStatus.setSUBJECT_ID(record.split("~")[11]);
           ...
           CLASS_MARK_ENTRYList.add(appStatus);
          }
          
        return CLASS_MARK_ENTRYList;
