 ...
 * @author DELL
 */
public class STUDENT_EXAM_BATCH_STATUS_ERROR_DataSource extends BatchDataSource<STUDENT_EXAM_BATCH_STATUS_ERROR>{

    String businessDate;
    
    @Override
      public List<STUDENT_EXAM_BATCH_STATUS_ERROR> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_EXAM_BATCH_STATUS_ERROR_DataSet(businessDate);  
