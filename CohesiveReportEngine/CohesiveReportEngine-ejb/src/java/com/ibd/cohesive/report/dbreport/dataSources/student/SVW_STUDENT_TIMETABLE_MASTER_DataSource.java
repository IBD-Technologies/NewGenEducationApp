 ...
 */
public class SVW_STUDENT_TIMETABLE_MASTER_DataSource extends StudentDataSource<SVW_STUDENT_TIMETABLE_MASTER>{
    String fileName;
    String instanceID;
    
    @Override
      public List<SVW_STUDENT_TIMETABLE_MASTER> fetch()
	{
            ...
            try
            {
               //parseParameters();
                ...
                ArrayList<SVW_STUDENT_TIMETABLE_MASTER> resultset=new ArrayList();
                ...
                if( preProcessor.preProcessing(this.getNokotser(), this.getUserID(), this.getLoginInstitute(), this.getService())){
                  ...
                  String result= appDataSet.getSVW_STUDENT_TIMETABLE_MASTER_DataSet(fileName, instanceID);
                  
                  SVW_STUDENT_TIMETABLE_MASTER errorMaster=new SVW_STUDENT_TIMETABLE_MASTER();
