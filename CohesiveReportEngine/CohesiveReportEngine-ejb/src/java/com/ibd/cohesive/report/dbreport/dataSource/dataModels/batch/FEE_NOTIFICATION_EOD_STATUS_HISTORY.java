 ...
 * @author ibdtech
 */
public class FEE_NOTIFICATION_EOD_STATUS_HISTORY {
    String INSTITUTE_ID;
    String FEE_ID;
    ...
    public void setSEQUENCE_NO(String SEQUENCE_NO) {
     ...
     public ArrayList<FEE_NOTIFICATION_EOD_STATUS_HISTORY>convertStringToArrayList(String result){
        
          ArrayList<FEE_NOTIFICATION_EOD_STATUS_HISTORY> FEE_NOTIFICATION_EOD_STATUS_HISTORYList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              FEE_NOTIFICATION_EOD_STATUS_HISTORY appStatus=new FEE_NOTIFICATION_EOD_STATUS_HISTORY();
              ...
              FEE_NOTIFICATION_EOD_STATUS_HISTORYList.add(appStatus);
          }
          
          
          return FEE_NOTIFICATION_EOD_STATUS_HISTORYList;
      }
