 ...
 * @author DELL
 */
public class STUDENT_TIMETABLE_BATCH_STATUS_HISTORY_DataSource extends BatchDataSource<STUDENT_TIMETABLE_BATCH_STATUS_HISTORY>{

    String businessDate;
    
    @Override
      public List<STUDENT_TIMETABLE_BATCH_STATUS_HISTORY> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_TIMETABLE_BATCH_STATUS_HISTORY_DataSet(businessDate);  
