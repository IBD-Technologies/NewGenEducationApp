 ...
 * @author DELL
 */
public class NOTIFICATION_EOD_STATUS {
    String INSTITUTE_ID;
    ...
    public void setEND_TIME(String END_TIME) {
     ...
     public ArrayList<NOTIFICATION_EOD_STATUS>convertStringToArrayList(String result){
        
          ArrayList<NOTIFICATION_EOD_STATUS> NOTIFICATION_EOD_STATUSList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              NOTIFICATION_EOD_STATUS appStatus=new NOTIFICATION_EOD_STATUS();
