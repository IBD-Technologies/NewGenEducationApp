 ...
 * @author DELL
 */
public class STUDENT_EXAM_BATCH_STATUS_DataSource extends BatchDataSource<STUDENT_EXAM_BATCH_STATUS>{

    String businessDate;
    
    @Override
      public List<STUDENT_EXAM_BATCH_STATUS> fetch()
	{
            ...
            try
            {
                ...
                return batchDataSet.getSTUDENT_EXAM_BATCH_STATUS_DataSet(businessDate);  
