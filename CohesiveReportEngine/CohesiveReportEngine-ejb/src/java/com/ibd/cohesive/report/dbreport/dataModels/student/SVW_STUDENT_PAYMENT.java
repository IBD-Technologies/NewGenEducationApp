 ...
 */
public class SVW_STUDENT_PAYMENT {
String STUDENT_ID;
String PAYMENT_ID;
String PAYMENT_MODE;
String PAYMENT_PAID;
...
String CHECKER_REMARKS;
    ...
    public String getPAYMENT_PAID() {
        return PAYMENT_PAID;
    }

    public void setPAYMENT_PAID(String PAYMENT_PAID) {
    ...
    public String getOUT_STANDING() {
        return OUT_STANDING;
    }

    public void setOUT_STANDING(String OUT_STANDING) {
    ...
    public void setREMARKS(String REMARKS) {
       ...
       public ArrayList<SVW_STUDENT_PAYMENT>convertStringToArrayList(String result){
        
          ArrayList<SVW_STUDENT_PAYMENT> SVW_STUDENT_PAYMENTList=new ArrayList();
          ...
          for(int i=0;i<records.length;i++){
              ...
              SVW_STUDENT_PAYMENT appStatus=new SVW_STUDENT_PAYMENT();
              ...
              appStatus.setFEE_ID(record.split("~")[5]);
              appStatus.setFEE_TYPE(record.split("~")[6]);
              ...
              appStatus.setOUT_STANDING(record.split("~")[10]);
              appStatus.setPAYMENT_DATE(record.split("~")[11]);
              appStatus.setPAYMENT_ID(record.split("~")[12]);
              appStatus.setPAYMENT_MODE(record.split("~")[13]);
              appStatus.setPAYMENT_PAID(record.split("~")[14]);
              appStatus.setRECORD_STATUS(record.split("~")[15]);
              appStatus.setREMARKS(record.split("~")[16]);
              appStatus.setSTUDENT_ID(record.split("~")[17]);
           ...
           SVW_STUDENT_PAYMENTList.add(appStatus);
          }
          
        return SVW_STUDENT_PAYMENTList;
