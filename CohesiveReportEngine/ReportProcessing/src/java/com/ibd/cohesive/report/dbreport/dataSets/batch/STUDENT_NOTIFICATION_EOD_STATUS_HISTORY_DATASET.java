 ...
 * @author DELL
 */
public class STUDENT_NOTIFICATION_EOD_STATUS_HISTORY_DATASET {
     public ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_HISTORY> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
        
        DirectoryStream<Path> stream =null;
        ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_HISTORY>totalEodList=new ArrayList();
        try{
        ...
        if(Files.notExists(ArchFolderPath)){
         ...
         if(totalEodList.isEmpty()){
              ...
              ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_HISTORY>dataset=new ArrayList();
                STUDENT_NOTIFICATION_EOD_STATUS_HISTORY appEod=new STUDENT_NOTIFICATION_EOD_STATUS_HISTORY();
    ...
    private ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_HISTORY> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session)throws DBProcessingException{
    
        ArrayList<STUDENT_NOTIFICATION_EOD_STATUS_HISTORY>dataset=new ArrayList();
        try{
            
            
            dbg("inside STUDENT_NOTIFICATION_EOD_STATUS_HISTORY_DATASET convertDBtoReportObject",session);
            ...
            if(l_tableMap!=null&&!l_tableMap.isEmpty()){
                ...
                while(recordIterator.hasNext()){
                    ...
                    STUDENT_NOTIFICATION_EOD_STATUS_HISTORY eod=new STUDENT_NOTIFICATION_EOD_STATUS_HISTORY();
            ...
            dbg("end of STUDENT_NOTIFICATION_EOD_STATUS_HISTORY_DATASET convertDBtoReportObject",session);
