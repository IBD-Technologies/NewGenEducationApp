 ...
 * @author DELL
 */
public class BATCH_STATUS_HISTORY_DATASET {
//    ArrayList<BATCH_STATUS_HISTORY> dataset;
    
    
    public ArrayList<BATCH_STATUS_HISTORY> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject,String batchName)throws DBProcessingException,DBValidationException{
        
        
        try{
        
        dbg("inside BATCH_STATUS_HISTORY_DATASET--->getTableObject",session);    
...
Map<String,DBRecord>l_tableMap=null;
       ...
       try{
        ...
        l_tableMap=readBuffer.readTable("INSTITUTE"+i_db_properties.getProperty("FOLDER_DELIMITER")+p_instituteID+i_db_properties.getProperty("FOLDER_DELIMITER")+"BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+p_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+p_businessDate, "BATCH", "BATCH_STATUS_HISTORY", session, dbSession,ismaxVersionRequired);
            ...
            if(ex.toString().contains("DB_VAL_011")||ex.toString().contains("DB_VAL_000")){
                ...
                ArrayList<BATCH_STATUS_HISTORY>dataset=new ArrayList();
                BATCH_STATUS_HISTORY appEod=new BATCH_STATUS_HISTORY();
         ...
         dbg("end of BATCH_STATUS_HISTORY_DATASET--->getTableObject",session);  
    ...
    private ArrayList<BATCH_STATUS_HISTORY> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session,String batchName)throws DBProcessingException{
    
        ArrayList<BATCH_STATUS_HISTORY>dataset=new ArrayList();
        try{
            
            
            dbg("inside BATCH_STATUS_HISTORY_DATASET convertDBtoReportObject",session);
...
List<DBRecord> filteredRecords;
                ...
                while(recordIterator.hasNext()){
                    ...
                    BATCH_STATUS_HISTORY eod=new BATCH_STATUS_HISTORY();
            ...
            dbg("end of BATCH_STATUS_HISTORY_DATASET convertDBtoReportObject",session);
