 ...
 * @author DELL
 */
public class STUDENT_NOTIFICATION_SMS_ERROR_DATASET {
    public ArrayList<STUDENT_NOTIFICATION_SMS_ERROR> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
        
        DirectoryStream<Path> stream =null;
        ArrayList<STUDENT_NOTIFICATION_SMS_ERROR>totalEodList=new ArrayList();
        try{
...
if(Files.notExists(ArchFolderPath)){
    ...
    private ArrayList<STUDENT_NOTIFICATION_SMS_ERROR> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session)throws DBProcessingException{
    
       ArrayList<STUDENT_NOTIFICATION_SMS_ERROR> dataset=new ArrayList();
        try{
            
            
            dbg("inside STUDENT_NOTIFICATION_SMS_ERROR_DATASET convertDBtoReportObject",session);
            ...
            if(l_tableMap!=null&&!l_tableMap.isEmpty()){
                ...
                while(recordIterator.hasNext()){
                    ...
                    STUDENT_NOTIFICATION_SMS_ERROR eod=new STUDENT_NOTIFICATION_SMS_ERROR();
                    ...
                    eod.setMOBILE_NO(l_eodRecords.getRecord().get(4).trim());
            ...
            dbg("end of STUDENT_NOTIFICATION_SMS_ERROR_DATASET convertDBtoReportObject",session);
