...
public class STUDENT_ASSIGNMENT_EOD_STATUS_DATASET {
 public ArrayList<STUDENT_ASSIGNMENT_EOD_STATUS> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
        ...
        dbg("inside STUDENT_ASSIGNMENT_EOD_STATUS_DATASET--->getTableObject",session);    
...
//        return   convertDBtoReportObject(l_tableMap,session) ;
    ...
    private ArrayList<STUDENT_ASSIGNMENT_EOD_STATUS> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session)throws DBProcessingException{
    
        ArrayList<STUDENT_ASSIGNMENT_EOD_STATUS>dataset=new ArrayList();
        try{
            
            
            dbg("inside STUDENT_ASSIGNMENT_EOD_STATUS_DATASET convertDBtoReportObject",session);
            ...
            if(l_tableMap!=null&&!l_tableMap.isEmpty()){
                ...
                while(recordIterator.hasNext()){
                    ...
                    STUDENT_ASSIGNMENT_EOD_STATUS eod=new STUDENT_ASSIGNMENT_EOD_STATUS();
            ...
            dbg("end of STUDENT_ASSIGNMENT_EOD_STATUS_DATASET convertDBtoReportObject",session);
