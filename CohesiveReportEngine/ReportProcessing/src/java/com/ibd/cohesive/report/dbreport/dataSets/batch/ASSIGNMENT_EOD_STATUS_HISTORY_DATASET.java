...
public ArrayList<ASSIGNMENT_EOD_STATUS_HISTORY> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
        ...
        dbg("inside ASSIGNMENT_EOD_STATUS_HISTORY_DATASET--->getTableObject",session);    
    ...
    private ArrayList<ASSIGNMENT_EOD_STATUS_HISTORY> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session)throws DBProcessingException{
    
       ArrayList<ASSIGNMENT_EOD_STATUS_HISTORY> dataset=new ArrayList();
        try{
            
            
            dbg("inside ASSIGNMENT_EOD_STATUS_HISTORY_DATASET convertDBtoReportObject",session);
            ...
            if(l_tableMap!=null&&!l_tableMap.isEmpty()){
                ...
                while(recordIterator.hasNext()){
                    ...
                    ASSIGNMENT_EOD_STATUS_HISTORY eod=new ASSIGNMENT_EOD_STATUS_HISTORY();
            ...
            dbg("end of ASSIGNMENT_EOD_STATUS_HISTORY_DATASET convertDBtoReportObject",session);
