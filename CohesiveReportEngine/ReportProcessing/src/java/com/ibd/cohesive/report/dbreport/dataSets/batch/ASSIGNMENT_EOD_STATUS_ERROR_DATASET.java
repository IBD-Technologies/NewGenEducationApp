...
public class ASSIGNMENT_EOD_STATUS_ERROR_DATASET {
 public ArrayList<ASSIGNMENT_EOD_STATUS_ERROR> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
        ...
        dbg("inside ASSIGNMENT_EOD_STATUS_ERROR_DATASET--->getTableObject",session);    
    ...
    private ArrayList<ASSIGNMENT_EOD_STATUS_ERROR> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session)throws DBProcessingException{
        ...
        try{
            ...
            if(l_tableMap!=null&&!l_tableMap.isEmpty()){
                ...
                while(recordIterator.hasNext()){
                    ...
                    ASSIGNMENT_EOD_STATUS_ERROR eod=new ASSIGNMENT_EOD_STATUS_ERROR();
            ...
            dbg("end of ASSIGNMENT_EOD_STATUS_ERROR_DATASET convertDBtoReportObject",session);
