var queryConfig={Operation:'query',
                                ...
                                triggerElement:'<div id="test-l-1" role="tabpanel" class="bs-stepper-pane active" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must enter Institute name and click Generate to generate Institute report</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                                 ...
                                 '<label for="studentId">Institute ID</label>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="3" type="text" id="Standard" class="form-control" placeholder="Enter standard ">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                   ...
                                   '<div class="fixedFooter">\n'+
                                    ...
                                    '</li>\n'+
                                    '<li class="next">\n'+
                                    '<a href="javascript:void(0);" tabindex="4" class="waves-effect">Generate <span aria-hidden="true">→</span></a>\n'+
                                    '</li>\n'+
                                    '</ul>\n'+
                                    '</nav>\n'+
                                    '</div>\n'+
                              ...
                              {stepNumber:2,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  '<h2 class="font-bold col-blue">Step 2: Generated Institute Report</h2>\n'+
                                 '<br>\n'+
