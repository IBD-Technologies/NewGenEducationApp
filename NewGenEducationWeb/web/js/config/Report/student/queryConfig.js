var queryConfig={Operation:'query',
                                ...
                                triggerElement:'<div id="test-l-1" role="tabpanel" class="bs-stepper-pane active" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must enter student name and click Generate to generate student report</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:2,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  '<h2 class="font-bold col-blue">Step 2: Generated Student Report</h2>\n'+
                                 '<br>\n'+
