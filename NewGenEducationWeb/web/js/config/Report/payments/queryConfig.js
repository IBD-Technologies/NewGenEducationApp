var queryConfig={Operation:'query',
                                ...
                                triggerElement:'<div id="test-l-1" role="tabpanel" class="bs-stepper-pane active" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must enter Filter criteria and click Generate to generate Payment report</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                                 ...
                                 '<label for="studentId">Student ID</label>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="feeID" class="form-control" placeholder="Enter id ">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                              ...
                              {stepNumber:2,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  '<h2 class="font-bold col-blue">Step 2: Generated Payment report</h2>\n'+
                                 '<br>\n'+
