var modificationConfig={Operation:'modification',
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  '<h2 class="font-bold col-blue">Step 4: Extracurricular activities detailed view</h2>\n'+
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please edit the fields which you want to modify and press submit.</p>\n'+
          ...
          '<div role="tabpanel" class="tab-pane fade in active" id="general">\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="name" class="form-control" value="Shagambaree R"  ">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="name" class="form-control" value="Student6"  ">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="ActivityID" class="form-control autocomplete"  value="O23200006">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="ActivityDescription" class="form-control autocomplete"  value="Sports day - Athletic Competttion">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="Participations" class="form-control autocomplete"  value="No">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="Result" class="form-control autocomplete"  value="Sports day - Athletic Competttion">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
          ...
          '<div role="tabpanel" class="tab-pane fade" id="Others">\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="4"  type="text"  class="form-control LastItem"  value="25-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+ 
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="4"  type="text"  class="form-control LastItem"  value="24-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+ 
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="Venue" class="form-control autocomplete"  value="School Ground">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
