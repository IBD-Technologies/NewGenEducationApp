var studentProfileQueryConfig = {Operation: 'query',
    startStep: 1,
    endStep: 4,
    step:
            [{stepNumber: 1, stepperLabel: 'Select Operation',
                ...
                {stepNumber: 2, stepperLabel: '',
                    triggerElement: '<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n' +
                            '<br>\n' +
                            '<div class="header">\n' +
                            '<h6 class="font-bold col-blue">Current step 2: Enter filter criteria</h6>\n' +
                            ...
                            '<div class="panel-body">\n' +
                            '<ul>\n' +
                            '<li>Please find the record to Query by entering the filter criteria</li>\n' +
                ...
                {stepNumber: 3, stepperLabel: '',
                    triggerElement: '<div id="test-l-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n' +
                            '<div class="header">\n' +
                            '<h6 class="font-bold col-blue">Current step 3: Student profile results based on given filter criteria</h6>\n' +
                            '<div class="panel-group" id ="helpContainer" role ="tablist" aria-multiselectable="true">\n' +
                            '<div class="panel panel-col-orange">\n' +
                            '<div class="panel-heading" role="tab" id="Help">\n' +
                            '<h4 class="panel-title">\n' +
                ...
                {stepNumber: 4, stepperLabel: '',
                    triggerElement: '<div id="test-l-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n' +
                            '<div>\n' +
                            '<h6 class="font-bold col-blue">Current step 4: Student detailed view</h6>\n' +
                            '<div class="panel-group" id ="helpContainer" role ="tablist" aria-multiselectable="true">\n' +
                            '<div class="panel panel-col-orange">\n' +
                            '<div class="panel-heading" role="tab" id="Help">\n' +
                            '<h4 class="panel-title">\n' +
                            '<a role="button" data-toggle="collapse" data-parent="#helpContainer" href="#collapseHelp" aria-expanded="true" aria-controls="collapseHelp">\n' +
                            '<i class="material-icons">help_outline</i>\n' +
                            '<span>Help</span>\n' +
                            '</a>\n' +
                            '</h4>\n' +
                            ...
                            '<div id="collapseHelp" class="panel-collapse collapse" role="tabpanel" aria-labelledby="Help">\n' +
                            '<div class="panel-body">\n' +
                            'Well done!</strong> You successfully completed the query.Please click corresponding tabs to view student General, Family, Address and Other details respectively.\n' +
                            '</div>\n' +
                            '</div>\n' +
                            '</div>\n' +
                            '</div>\n' +
