var queryConfig={Operation:'query',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must enter filter criteria for Teacher Time Table which you want to query</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                                 ...
                                 '<label for="studentClass">Class</label>\n'+
                                  ...
                                  '<select tabindex="2" id="studentClass" class="form-control form-line show-tick">\n'+
                                  ...
                                  '</span>\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="4"  type="text"  class="form-control" placeholder="Enter To Date in dd-mm-yyyy format">\n'+
                                  '</div>\n'+
                                  '</div>\n'+

                                  '<label for="Status">Status</label>\n'+
                                  '<div class="input-group input-group-lg">\n'+
                                  '<select tabindex="5" id="Status" class="form-control form-line show-tick">\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   ...
                                   '<strong><i class="material-icons">help_outline</i> Well done!</strong> You successfully completed the query.Please view the result for choosen Teacher Leave Management details\n'+
                                    '</div>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// Mon start
    '<div role="tabpanel" class="tab-pane fade in active" id="General">\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="name" class="form-control autocomplete" readonly value="Teacher1">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="id" class="form-control autocomplete" readonly value="Teacher1">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '</span>\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="3"  type="text"  class="form-control" readonly value="20-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                  ...
                                  '<option disabled value="1">FullDay</option>\n'+
                                  '</select>\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '</span>\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="5"  type="text"  class="form-control" readonly value="22-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                  ...
                                  '<option disabled value="1">Planned</option>\n'+
                                  '<option disabled value="1">Casual</option>\n'+
                                  '</select>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<textarea tabindex="8" rows="2" id="reason" class="form-control resize" readonly>Sick Leave</textarea>\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<option disabled value="1">Unauthorized</option>\n'+
                                  '<option disabled value="1">Rejected</option>\n'+
                                  '</select>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<textarea tabindex="10" rows="2" id="Reamarks" class="form-control resize LastItem" readonly>none</textarea>\n'+
                                  '</div>\n'+
                                  '</div>\n'+               
