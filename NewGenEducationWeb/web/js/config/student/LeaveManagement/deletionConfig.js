var deletionConfig={Operation:'deletion',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must enter filter criteria for Student Time Table which you want to delete</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                                 ...
                                 '<span class="input-group-addon">\n'+
                                  ...
                                  '<div class="input-group input-group-lg">\n'+
                                  '<select tabindex="6" id="Status" class="form-control form-line show-tick">\n'+
                              ...
                              {stepNumber:3,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please select the checkbox or double click on the row that you want to delete the result.</p>\n'+
                                  '</div>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please view the details first and then press delete to delete the Student Leave Management</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// Mon start
    '<div role="tabpanel" class="tab-pane fade in active" id="General">\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="name" class="form-control autocomplete" readonly value="Student1">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
