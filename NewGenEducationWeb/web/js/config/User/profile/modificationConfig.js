var modificationConfig={Operation:'modification',
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please click corresponding tabs to Modify User Profile General, Parent, Class etc details respectively and then press submit.</p>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="student_name" class="form-control"  value="R.Anitha">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="UserId" class="form-control"  value="9566205415">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="3" type="password" id="Password" class="form-control"  value="fhdjkffhjksdf">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<input tabindex="4" type="text"  class="form-control"  value="21-01-2090">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="6" type="text" id="HomeInstitute" class="form-control"  value="ABC Matriculation School">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="8" type="text" id="HomeInstitute" class="form-control" >\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="roleId" class="form-control"  value="PARENT">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="studentName" class="form-control"  value="Student1">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="3" type="text" id="studentId" class="form-control"  value="Student2">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="4" type="text" id="InstituteName" class="form-control"  value="ABC Matriculation School">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
