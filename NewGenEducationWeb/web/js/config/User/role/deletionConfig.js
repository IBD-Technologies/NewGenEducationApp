var deletionConfig={Operation:'deletion',
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please click corresponding tabs to view User Role General, Parent etc details and then press delete.</p>\n'+
                                  '</div>\n'+
