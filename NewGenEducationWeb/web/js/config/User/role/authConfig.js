var authConfig={Operation:'authorization',
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please click corresponding tabs to view User Role details and then press authorize or reject.</p>\n'+
                                  '</div>\n'+
