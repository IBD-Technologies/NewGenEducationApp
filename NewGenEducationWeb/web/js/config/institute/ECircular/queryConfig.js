var queryConfig={Operation:'query',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose the filter criteria for eCircular which you want to query</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   ...
                                   '<strong><i class="material-icons">help_outline</i> Well done!</strong> You successfully completed the query.Please view the result for chosen eCircular details\n'+
                                    '</div>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
