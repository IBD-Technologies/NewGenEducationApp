var instituteClassAuthConfig={Operation:'authorization',
                                startStep : 1,
                                endStep:4,
                                step: 
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<h2 class="font-bold col-blue">Step 2: Enter Filter Criteria for Authorization/Rejection</h2>\n'+
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must select class name in the filter criteria which you want to Authorize/Reject</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please view the detailed view and press Authorization/Rejec for Institute class.</p>\n'+
                                  '</div>\n'+
