var instituteClassDeleteConfig={Operation:'deletion',
                                startStep : 1,
                                endStep:4,
                                step: 
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must select class name in the filter criteria which you want to delete</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:3,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Press on relevent record row and press next to get detailed view.</p>\n'+
                                  '</div>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  '<h2 class="font-bold col-blue">Step 4: Institute class detailed view</h2>\n'+
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please view the detailed view and press delete to delete the Institute class.</p>\n'+
                                  '</div>\n'+
...
// general content start
    ...
    '<label for="StudentName">Class</label>\n'+
                                  ...
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="StudentName" class="form-control autocomplete" readonly value="IX/B">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="teacherName" class="form-control autocomplete" readonly value="Teacher2">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="3" type="text" id="teacherId" class="form-control autocomplete" readonly value="Teacher2">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="5" type="text" id="periodNumber" class="form-control autocomplete" readonly value="1">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  ...
                                  '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                        ...
                                        '<div class="input-group">\n'+
                                            ...
                                            '</span>\n'+
                                            '<div class="form-line">\n'+
                                                '<input tabindex="6" type="text" class="form-control time12" readonly value="09 : 30">\n'+
                                            '</div>\n'+
                                        '</div>\n'+
                                    '</div>\n'+
                                    '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                        ...
                                        '<div class="input-group">\n'+
                                            ...
                                            '</span>\n'+
                                            '<div class="form-line">\n'+
                                                '<input tabindex="7" type="text" class="form-control time12" readonly value="10 : 15">\n'+
                                            '</div>\n'+
                                        '</div>\n'+
                                    '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="8" type="text" id="noon" class="form-control autocomplete" readonly value="Forenoon">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
...
'</div>\n'+
                                  ...
                                  '<div class="fixedFooter">\n'+
                                    ...
                                    '</li>\n'+
                                    '<li class="next">\n'+
                                    '<a href="javascript:void(0);" tabindex="9" class="waves-effect">Delete <span aria-hidden="true">→</span></a>\n'+
                                    '</li>\n'+
                                    '</ul>\n'+
                                    '</nav>\n'+
                                    '</div>\n'+
