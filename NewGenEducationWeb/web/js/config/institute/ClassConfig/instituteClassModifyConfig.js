var instituteClassModifyConfig={Operation:'modification',
                                startStep : 1,
                                endStep:4,
                                step: 
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must select class name in the filter criteria which you want to modify</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:3,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please click corresponding row and press next or double click on that row.</p>\n'+
                                  '</div>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please click corresponding view and change the values that you want to modify and press submit.</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// general content start
    ...
    '<label for="StudentName">Class</label>\n'+
                                  ...
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="StudentName" class="form-control autocomplete"  value="IX/B">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="teacherName" class="form-control autocomplete"  value="Teacher2">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="3" type="text" id="teacherId" class="form-control autocomplete"  value="Teacher2">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<option  value="">--Choose Auth status--</option>\n'+
                                  '<option selected value="Male">Daywise</option>\n'+
                                  '<option  value="Male">Weekly</option>\n'+
                                  '</select>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="5" type="text" id="periodNumber" class="form-control autocomplete"  value="1">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  ...
                                  '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                        ...
                                        '<div class="input-group">\n'+
                                            ...
                                            '</span>\n'+
                                            '<div class="form-line">\n'+
                                                '<input tabindex="6" type="text" class="form-control time12"  value="09 : 30">\n'+
                                            '</div>\n'+
                                        '</div>\n'+
                                    '</div>\n'+
                                    '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                        ...
                                        '<div class="input-group">\n'+
                                            ...
                                            '</span>\n'+
                                            '<div class="form-line">\n'+
                                                '<input tabindex="7" type="text" class="form-control time12"  value="10 : 15">\n'+
                                            '</div>\n'+
                                        '</div>\n'+
                                    '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="8" type="text" id="noon" class="form-control autocomplete LastItem"  value="Forenoon">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
...
'</div>\n'+
                                  ...
                                  '<div class="fixedFooter">\n'+
                                    ...
                                    '</li>\n'+
                                    '<li class="next">\n'+
                                    '<a href="javascript:void(0);" tabindex="9" class="waves-effect">Submit <span aria-hidden="true">→</span></a>\n'+
                                    '</li>\n'+
                                    '</ul>\n'+
                                    '</nav>\n'+
                                    '</div>\n'+
