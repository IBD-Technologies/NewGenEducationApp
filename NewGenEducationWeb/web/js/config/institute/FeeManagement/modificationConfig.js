var modificationConfig={Operation:'modification',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose the Auth status for group which you want to query</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please edit the fields that you want to modify for fee and click submit.</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// general content start
    ...
    '<label for="feeId">Fee ID</label>\n'+
                                  ...
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="feeId" class="form-control autocomplete"  value="F11200000">\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="Description" class="form-control autocomplete"  value="Term fee">\n'+
                                  '</div>\n'+
                                  '</div>\n'+                                  
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="4" type="text" id="amount" class="form-control autocomplete"  value="2,000.00">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="5" type="text" id="assigneeGroup" class="form-control autocomplete LastItem"  value="G9200002">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="6"  type="text"  class="form-control LastItem"  value="13-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
