var authConfig={Operation:'authorization',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose Filter criteria for Fee which you want to Authorize/Reject</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please edit the fields that you want to Authorize/Reject.</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
