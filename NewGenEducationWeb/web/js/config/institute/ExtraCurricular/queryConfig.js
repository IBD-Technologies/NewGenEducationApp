                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   ...
                                   '<strong><i class="material-icons">help_outline</i> Well done!</strong> You successfully completed the query.Please view the result for chosen Notification details\n'+
                                    '</div>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
