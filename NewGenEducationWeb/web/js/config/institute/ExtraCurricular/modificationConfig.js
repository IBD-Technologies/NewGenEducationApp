var modificationConfig={Operation:'modification',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose the filter criteria for extra curricular activity which you want to query</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
...
// general content start
    '<div role="tabpanel" class="tab-pane fade in active" id="general">\n'+
        ...
        '<label for="ActivityID">Activity ID</label>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="4" type="text" id="AssigneeGroup" class="form-control autocomplete"  value="G19200000">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<input tabindex="5"  type="text"  class="form-control LastItem"  value="25-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="6"  type="text"  class="form-control LastItem"  value="24-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+ 
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="8" type="text" id="Venue" class="form-control autocomplete LastItem"  value="School Ground">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
