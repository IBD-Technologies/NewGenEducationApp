var modificationConfig={Operation:'modification',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose the filter criteria for Notification which you want to query</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please edit the fields you want to modify and press submit.</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// general content start
    '<div role="tabpanel" class="tab-pane fade in active" id="general">\n'+
        ...
        '<label for="NotificationID">Notification ID</label>\n'+
                                  ...
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="NotificationID" class="form-control autocomplete"  value="N19200018">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="3" type="text" id="Assignee" class="form-control autocomplete"  value="G19200000">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="5" type="text" id="InEnglish" class="form-control autocomplete"  value="Read English Lesson -4">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="6" type="text" id="OtherLanguage" class="form-control autocomplete"  value="ஆங்கில பாடம் -3 ஐப் படியுங்கள்">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="7"  type="text"  class="form-control LastItem"  value="20-01-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
...
// test start
    '<div role="tabpanel" class="tab-pane fade" id="details">\n'+
       ...
       '<label for="TestEmail">Test Email ID</label>\n'+
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="TestEmail" class="form-control autocomplete"  value="some@example.com">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="2" type="text" id="TestMobile" class="form-control autocomplete"  value="+91 3434 34343">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
