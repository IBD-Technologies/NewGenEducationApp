var modificationConfig={Operation:'modification',
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please view the detailed view for the fee payment and modify by clicking General and Details Tabs and press Submit.</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// general content start
    '<div role="tabpanel" class="tab-pane fade in active" id="general">\n'+
        ...
        '<label for="paymentID">Payment ID</label>\n'+
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="paymentID" class="form-control autocomplete"  value="P97200021">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line" id="bs_datepicker_container">\n'+
                                  '<input tabindex="2"  type="text"  class="form-control"  value="28-04-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="4" type="text" id="studentId" class="form-control autocomplete"  value="Student20">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="5" type="text" id="amount" class="form-control autocomplete"  value=" 1,000.00">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
