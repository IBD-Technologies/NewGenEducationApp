var instituteAuthConfig={Operation:'authorization',
                                startStep : 1,
                                endStep:3,
                                step: 
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<h2 class="font-bold col-blue">Step 2: Enter Filter Criteria for Authorization</h2>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:3,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please click corresponding tabs to view Institute General, Exam, Grade, Subject, Notification, Fee,  and Audit details respectively and press Authorize/Reject.</p>\n'+
                                  '</div>\n'+
