var instituteQueryConfig={Operation:'query',
                                startStep : 1,
                                endStep:3,
                                step: 
                              ...
                              {stepNumber:3,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<div class="alert alert-warning ">\n'+
                                   '<strong><i class="material-icons">help_outline</i> Well done!</strong> You successfully completed the query.Please click corresponding tabs to view Institute General, Exam, Grade, Subject, Notification, Fee,  and Audit details respectively.\n'+
                                    '</div>\n'+
                                  ...
                                  '<div class="form-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input id="BSbtninfo" class="form-control LastItem" type="file" disabled value="abc.png" readonly  /> \n'+
                                  '<lable>abc.png</lable>\n'+
                                  '</div>\n'+
