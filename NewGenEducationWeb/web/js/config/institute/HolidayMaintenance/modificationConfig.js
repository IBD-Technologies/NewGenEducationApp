var modificationConfig={Operation:'modification',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<select id="studentClass" class="form-control form-line show-tick">\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="StudentName" class="form-control autocomplete"  value="IX/B">\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="teacherName" class="form-control autocomplete"  value="Teacher2">\n'+
                                  '</div>\n'+

                                  '<label for="teacherId">Teacher ID</label>\n'+
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="teacherId" class="form-control autocomplete"  value="Teacher2">\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="periodNumber" class="form-control autocomplete"  value="1">\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input type="text" id="noon" class="form-control autocomplete"  value="Forenoon">\n'+
                                  '</div>\n'+
