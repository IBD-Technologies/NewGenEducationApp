                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<div class="alert alert-warning ">\n'+
                                   '<strong><i class="material-icons">help_outline</i> Well done!</strong> You successfully completed the query.Please view Detaled view for the choosen Group.\n'+
                                    '</div>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i></p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
