var modificationConfig={Operation:'modification',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose the Auth status for group which you want to modify</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:3,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please select the checkbox or double click on the row that you want to modify.</p>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="fixedFooter">\n'+
                                    ...
                                    '</li>\n'+
                                    '<li class="next">\n'+
                                    '<a href="javascript:void(0);" tabindex="2" class="waves-effect">Submit <span aria-hidden="true">→</span></a>\n'+
                                    '</li>\n'+
                                    '</ul>\n'+
                                    '</nav>\n'+
                                    '</div>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please view the detaled view for the choosen Group and after press submit.</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
// general content start
    ...
    '<label for="groupId">Group ID</label>\n'+
                                  ...
                                  '<div class="form-line">\n'+
                                  '<input tabindex="1" type="text" id="groupId" class="form-control autocomplete"  value="IX/B">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '<option  value="Male">BS Software Engineering</option>\n'+
                                  '</select>\n'+
                                  '</div>\n'+
                                  ...
                                  '<div class="form-group input-group">\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="4" type="text" id="studentName" class="form-control autocomplete LastItem"  value="Forenoon">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
...
'</div>\n'+
                                  ...
                                  '<div class="fixedFooter">\n'+
                                    ...
                                    '</li>\n'+
                                    '<li class="next">\n'+
                                    '<a href="javascript:void(0);" tabindex="5" class="waves-effect">Submit <span aria-hidden="true">→</span></a>\n'+
                                    '</li>\n'+
                                    '</ul>\n'+
                                    '</nav>\n'+
                                    '</div>\n'+
