var createConfig={Operation:'create',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<h2 class="font-bold col-blue">Step 2: Enter Data To create Teacher Time Table</h2>\n'+
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must enter all fields to create Teacher Time Table and press next </p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
...
// Mon Start
    '<div role="tabpanel" class="tab-pane fade in active" id="Mon">\n'+
                                 ...
                                 '<div class="header familHeader">\n'+
                                  ...
                                  '<div class="input-group input-group-lg">\n'+
                                  '<select tabindex="4" id="periodNumber" class="form-control form-line show-tick">\n'+
