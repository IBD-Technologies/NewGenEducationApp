var enroll={Operation:'enroll',
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                  ...
                                  '<div class="alert alert-warning ">\n'+
                                   '<strong><i class="material-icons">help_outline</i> Well done!</strong> You successfully got the result. Please click corresponding tabs to view Student Ecircular details and click Enroll to get enrolled for the activity.\n'+
                                    '</div>\n'+
         ...
         '</div>\n'+
                                  ...
                                  '<div class="fixedFooter">\n'+
                                    ...
                                    '</li>\n'+
                                     '<li class="next">\n'+
                                    '<a href="javascript:void(0);" class="waves-effect">Enroll <span aria-hidden="true">→</span></a>\n'+
                                    '</li>\n'+
                                    '</ul>\n'+
                                    '</nav>\n'+
                                    '</div>\n'+
