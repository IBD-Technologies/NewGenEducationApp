var stepperOneTemplate='<div id="test-l-1" role="tabpanel" class="bs-stepper-pane active" aria-labelledby="stepper1trigger1">\n'+
                ...
                '<br>\n'+
                   ...
                   '</div>\n'+
               '</div>\n'+
               '<div id="enroll" onclick="stepOneSetAction(this.id)" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n'+
                '<div  class="card  waves-effect waves-block iconCards">\n'+
                    '<div class="header bg-white" >\n'+
                        '<h2>\n'+
                            '<img class="operationIcon" src="images/modification.png"><font  style="margin-left: 10px;">Enroll</font>\n'+
                        '</h2>\n'+
                        '<ul class="header-dropdown m-r--5">\n'+
                           '<i class="material-icons setAction hidden">check</i>\n'+
                       '</ul>\n'+
           ...
           '<div id="modification" onclick="stepOneSetAction(this.id)" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n'+
                '<div  class="card  waves-effect waves-block iconCards">\n'+
                    '<div class="header bg-white" >\n'+
                        '<h2>\n'+
                            '<img class="operationIcon" src="images/modification.png"><font  style="margin-left: 10px;">Modification</font>\n'+
                        '</h2>\n'+
                        '<ul class="header-dropdown m-r--5">\n'+
                           '<i class="material-icons setAction hidden">check</i>\n'+
                       '</ul>\n'+
        ...
        '<div class="card  waves-effect waves-block iconCards">\n'+
            '<div class="header bg-white" >\n'+
                '<h2>\n'+
                    '<img class="operationIcon" src="images/authorization.png"><font  style="margin-left: 10px;">Authorization</font>\n'+
                '</h2>\n'+
                '<ul class="header-dropdown m-r--5">\n'+
                   '<i class="material-icons setAction hidden">check</i>\n'+
               '</ul>\n'+
