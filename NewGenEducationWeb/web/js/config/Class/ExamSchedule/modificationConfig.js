var modificationConfig={Operation:'modification',
                                ...
                                triggerElement:'<div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">\n'+
                                  ...
                                  '<br>\n'+
                                  '<p class="col-orange"><i class="material-icons">help_outline</i>Please must choose filter criteria for Class Exam Shedule which you want to modify</p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
                                  '<br>\n'+
                              ...
                              {stepNumber:4,stepperLabel:'',
                                ...
                                '<div class="header block">\n'+
                                 ...
                                 '<br>\n'+
                                   '<p class="col-orange"><i class="material-icons">help_outline</i>Please edit the details which you want to modify and press submit to modify the updated details for Class Exam Schedule </p>\n'+
                                  '</div>\n'+
                                  '<br>\n'+
...
'<div class="tab-content">\n'+
    ...
    '<div role="tabpanel" class="tab-pane fade in active" id="General">\n'+
                                  ...
                                  '<input tabindex="4"  type="text"  class="form-control"  value="05-02-2020">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  ...
                                  '</span>\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="5" type="text" class="form-control time12"   value="10 : 30">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">\n'+
                                  ...
                                  '</span>\n'+
                                  '<div class="form-line">\n'+
                                  '<input tabindex="6" type="text" class="form-control time12"   value="12: 30">\n'+
                                  '</div>\n'+
                                  '</div>\n'+
                                  '</div>\n'+
