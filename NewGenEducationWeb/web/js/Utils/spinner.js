...
function fn_show_spinner()
{
	...
	innerHtml="<div class=\"modal fade\" id=\"spinnerModal\" tabindex=\"-1\" role=\"dialog\" style=\"display: none;\">";
	innerHtml+="<div class=\"modal-dialog modal-dialog-centered modal-sm\" role=\"document\">";
	innerHtml+="   <div class=\"modal-content modal-size\">";
    innerHtml+=                    "<div class=\"modal-header\">";
    innerHtml+=  "<p class=\"modal-title\" id=\"smallModalLabel\">Please wait!<span class=\"emojiSize\">🤔</span></p>";
	                                  
	//innerHtml+=                        "<h1 class=\"emojiSize\">🤔</h1> </span>"; 
	//innerHtml+=                        " <img class=\"imageSize\" src=\"images/business-and-finance.png\">";                 
    innerHtml+=                     "</div>";
    innerHtml+=                        "<div class=\"modal-body spinner-center\">";
	//innerHtml+=                        "<h1 class=\"emojiSize\">🤔</h1> </span>"; 
	innerHtml+=                            "<div class=\"preloader pl-size-xs\">";
    innerHtml+=                                 "<div class=\"spinner-layer pl-pink\">"
    innerHtml+=                                         "<div class=\"circle-clipper left\">";
    innerHtml+=                                             "<div class=\"circle\"></div>";
    innerHtml+=                                          "</div>";
    innerHtml+=                                          "<div class=\"circle-clipper right\">";
    innerHtml+=                                               "<div class=\"circle\"></div>";
    innerHtml+=                                           "</div>";
    innerHtml+=                                   "</div>";
    innerHtml+=                            " </div>";
