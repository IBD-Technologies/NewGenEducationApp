        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="#"  class="bars" ></a>
                    <a class="navbar-brand" class='indexLink' href="#"><img id="logoImage" src="images/download.png"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown pull-right">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="#"  class=" waves-effect waves-block waves-blue">Help</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="info-container">
                        ...
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="#" ><i class="material-icons">account_balance</i>Change Institute</a></li>
                                <li><a href="#" ><i class="material-icons">vpn_key</i>Change Password</a></li>
