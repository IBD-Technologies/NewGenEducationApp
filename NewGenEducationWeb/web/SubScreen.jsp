...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/Utils/subScreen.min.css">
                            ...
                            <div class="body subScreenBody">
                             ...
                             <footer class="subScreenFooter" ng-show='ShowScreenFooter'>
                                <div class="btn-toolbar-custom">
                                  <div class="btn-group">
                                  <a id="previous" href='#' role="button" class="btn waves-effect" ng-show="ShowPrevButton">
                                    <div class="my-fancy-container"> 
                                    <i class="material-icons btn-txt-color">arrow_back</i>
                                    <span class="subScrFooterButton my-text btn-txt-color" >Previous</span>
                                    </div>
                                   </a>
                                      <a id="next" href='#' role="button" class="btn waves-effect" ng-show="ShowNextButton">
                                     <div class="my-fancy-container">
                                       <i class="material-icons btn-txt-color">arrow_forward</i>
                                       <span class="subScrFooterButton my-text btn-txt-color">Next</span>
                                     </div>   
                                   </a>
                                   
                                <a id="save" href='#' role="button" class="btn waves-effect" ng-show="ShowSaveButton">
                                    <div class="my-fancy-container"> 
                                    <i class="material-icons btn-txt-color">save</i> 
                                    <span class="subScrFooterButton my-text btn-txt-color">Save</span>
                                    </div>
                                </a>
                                <a id="delete" href='#' role="button" class="btn waves-effect" ng-show="ShowDeleteButton">
                                    <div class="my-fancy-container"> 
                                    <i class="material-icons btn-txt-color">delete</i> 
                                    <span class="subScrFooterButton my-text btn-txt-color">Delete</span>
                                    </div>
                                </a>
                                   
                                <a id="auth" href='#' role="button" class="btn waves-effect" ng-show="ShowAuthButton">
                                    <div class="my-fancy-container"> 
                                    <i class="material-icons btn-txt-color">check_circle</i> 
                                    <span class="subScrFooterButton my-text btn-txt-color">Auth</span>
                                    </div>
                                </a>
                                
                                    <a id="reject" href='#' role="button" class="btn waves-effect" ng-show="ShowRejectButton">
                                       <div class="my-fancy-container"> 
                                        <i class="material-icons btn-txt-color">cancel</i> 
                                        <span class="subScrFooterButton my-text btn-txt-color">Reject</span>
                                       </div> 
                                    </a>
                                     
                                    <a id="cancel" href='#' role="button" class="btn waves-effect" ng-show="ShowCancelButton">
                                    <div class="my-fancy-container"> 
                                    <i class="material-icons btn-txt-color">close</i> 
                                    <span class="subScrFooterButton my-text btn-txt-color">Cancel</span>
                                    </div>
                                    </a>
