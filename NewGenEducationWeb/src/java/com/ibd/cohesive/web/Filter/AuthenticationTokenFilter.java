 ...
 * ********************************
 * Change Desc : Material Design Conversion
 * Change Tag : CH001
 * Change By :Rajkumar Velusamy
 * Change Date:13-05-2020
 **************************************
...
public class AuthenticationTokenFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            ...
            dbg("AuthenticationTokenFilter:DoBeforeProcessing inside Newgen");
   ...
   return  serviceName;
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try
        {
         ...
         dbg("Inside Newgen AuthenticationTokenFilter");
      ...
      /*      synchronized (obj) {
        ...
        else if(httpRequest.getRequestURI().endsWith("/NewGenEducationApp")) //CH001
                {  
                    isLoginRequest=true;
                }
...
//        }
        ...
        boolean isLoginPage  = httpRequest.getRequestURI().endsWith("Login.min.jsp")||httpRequest.getRequestURI().endsWith("forgotPassword.min.jsp");//CH001
...
//                 throw ex;
    ...
    private void sendProcessingError(Throwable t, ServletResponse response) throws ServletException {
      ...
      //response.setHeader("X-Frame-Options","ALLOW-FROM blob:https://cohesive.ibdtechnologies.com");
       ...
       httpResponse.setHeader("Content-Security-Policy", "default-src 'self';font-src 'self' https://fonts.gstatic.com/ data: fonts.gstatic.com ;script-src 'self' 'unsafe-inline' 'unsafe-eval';style-src 'self' https://fonts.googleapis.com 'unsafe-inline';base-uri 'none';form-action 'self';frame-ancestors 'self';frame-src 'self'");
...
"<script type =\"text/javascript\" src=\"js/Utils/Exception.min.js\"></script> \n"+
//"<script src=\"/js/Utils/spinner.js\"></script>\n" +
      
"       <script src=\"js/Utils/error.min.js\"></script>\n" +
"	  \n" +
"   </head>\n" +
